...
* Adaptief Forms biedt een aantal speciale functies om de berekening voor herhaalbare deelvensters, zoals som, telling, min, max, filter en nog veel meer, te vereenvoudigen. Voor de volledige lijst met functies raadpleegt u [JavaScript™ Library API-referentie voor Adaptive Forms](https://helpx.adobe.com/aem-forms/6/javascript-api/af.html)
...
Wanneer de waarde van **huwelijks_status** veldwijzigingen, wordt de expressie opnieuw geactiveerd. U kunt dropdown van de dienst van REST ook bevolken. <!-- For detailed information, see [Dynamically populating dropdowns](dynamically-populate-dropdowns.md). -->
