...
# Een adaptief formulier aansluiten op Azure SQL-opslag
...
In dit artikel wordt beschreven hoe u een adaptief formulier via JDBC en AEM as a Cloud Service kunt verbinden met een Azure SQL-database.
...
* **Realtime gegevensinteractie:** laat levend lezen en het schrijven van gegevens tussen vormen en het gegevensbestand van Azure toe.
* **Schaalbaarheid:** SQL van Azure verstrekt scalable gegevensbestandprestaties geschikt voor onderneming-vlakke toepassingen.
* **gecentraliseerde gegevensopslag:** houdt vormvoorlegging en opgehaalde gegevens veilig opgeslagen in één centrale plaats.
* **de naleving van de Veiligheid:** hefboomwerkingen Azure ingebouwde netwerk, firewall, en encryptieopties om veilige mededeling te verzekeren.
...
**Stap 4: Creeer het Dossier van de Configuratie van de Verbinding van Azure SQL**
...
1. Voeg de volgende coderegels toe:
   ...
   >
   >
   > Vervang `jdbc.username` door de werkelijke Azure-gebruikersnaam en `jdbc.password` door het werkelijk beveiligde wachtwoord.
...
Nadat de AEM- en Azure-configuratie is voltooid en de codewijzigingen zijn geïmplementeerd:
