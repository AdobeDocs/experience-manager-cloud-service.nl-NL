...
## Technische account toevoegen aan de groep met gebruikers van formulieren

Voer de volgende stappen uit om de technische account toe te voegen aan `forms-users` Group in AEM:

1. Ga naar **Hulpmiddelen** > **Veiligheid** > **Gebruikers**.
1. Zoek in de lijst met gebruikers de e-mail met de technische account voor uw organisatie. Laten we bijvoorbeeld naar de gebruiker zoeken als `Workfront-test` .
1. Klik op de gebruiker om de gebruikersgegevens weer te geven.
1. In de gebruikersdetails, selecteer de **Groepen** tabel.
...
1. Ga naar **Hulpmiddelen** > **Veiligheid** > **Groepen**.
