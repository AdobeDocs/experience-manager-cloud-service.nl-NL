...
1. **Registreer een toepassing voor [!DNL Microsoft® Dynamics 365] in de Actieve Folder van Azure**
...
U kunt **identiteitskaart van de Cliënt 1&rbrace; terugwinnen en** Geheime Cliënt **van de Actieve Toepassing van de Folder van Azure.**
...
U kunt **[!UICONTROL OAuth URL]** terugwinnen, **[!UICONTROL Refresh Token URL]**, en **[!UICONTROL Access Token URL]** van de **Eindpunten** sectie van uw Toepassing van de Folder van Azure Actieve.
