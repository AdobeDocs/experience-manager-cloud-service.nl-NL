---
title: Hoe krijgt u referentiethema's en sjablonen voor adaptieve formulieren?
...
# Referentie Assets voor Forms as a Cloud Service {#reference-themes}

U kunt de verwijzingsthema&#39;s, de malplaatjes, en het model van vormgegevens (FDM) krijgen door het [ pakket van Assets van de Verwijzing ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aemcloud.html?package=/content/software-distribution/en/details.html/content/dam/aemcloud/public/aem-forms-reference-content.ui.content-2.0.0.zip) te installeren. Het helpt u om snel uw Adaptieve Forms-ontwikkeling te starten en te versnellen. U kunt [ Manager van het Pakket gebruiken ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developer-tools/package-manager.html) om dit pakket aan uw as a Cloud Service milieu van Forms op te stellen.
De referentieelementen die in het pakket zijn opgenomen, zijn:

## Thema&#39;s {#themes}

[ Thema&#39;s ](/help/forms/themes.md) laat u uw vormen zonder diepe kennis van CSS opmaken. De volgende thema&#39;s zijn opgenomen:
...
![ Thema&#39;s van de Verwijzing ](/help/forms/assets/ref-themes.png)
...
![ Tranquil thema ](/help/forms/assets/tranquil.png)
...
![ Microsoft® Dynamics 365 Model van de Gegevens van de Vorm ](/help/forms/assets/microsoft-dynamic-fdm.png)
...
![ Salesforce Model van de Gegevens van de Vorm ](/help/forms/assets/salesforce-fdm.png)
