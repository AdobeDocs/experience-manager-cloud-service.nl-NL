...
1. Open het **[!UICONTROL Advanced]** lusje bij de bovenkant van het **scherm van de Eigenschappen van het Project van de Vertaling**. Selecteer **[!UICONTROL Translation field]** voor **[!UICONTROL Human Translation]** . Klik **sparen &amp; dicht** bij de bovenkant van het scherm.
