...
>[!NOTE]
>
>**de naam van het Thema:** wanneer u een thema van Forms in uw plaatsthema inbedt en via de front-end pijpleiding opstelt, te hoeven u **om het even welke themanaam** niet te veranderen. De formulierstijlen worden onderdeel van uw bestaande site-thema, dat is gemaakt en geïmplementeerd met de huidige naam. Het veranderen van de themanaam (bijvoorbeeld in `package.json`) wordt slechts vereist wanneer u het thema van Forms van a **standalone** van een specifieke themabewaarplaats opstelt; dat scenario wordt beschreven in [&#x200B; de thema&#39;s van het Gebruik aan stijlKern op componenten-Gebaseerde Aangepaste Forms &#x200B;](/help/forms/using-themes-in-core-components.md).
