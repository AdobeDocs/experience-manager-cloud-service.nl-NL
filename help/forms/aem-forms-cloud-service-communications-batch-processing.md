...
**de configuratie van de Wolk van de Wolk van de Ervaring**: De configuratiehulp van de Wolk helpt u een instantie van Experience Manager met klant het bezeten opslag van Microsoft Azure verbinden. Hiermee kunt u de referenties opgeven waarmee Microsoft Azure-account van een klant verbinding kan maken.

**de configuratie van de Opslag van de Gegevens van de Partij (USC)**: De hulp van de de gegevensconfiguratie van de partij u vormt een specifiek geval van opslag Blob voor Partij APIs. Hiermee kunt u de invoer- en uitvoerlocaties opgeven in de Microsoft Blob-opslag van de klant.
...
**Opslag**: De mededeling APIs gebruikt klant bezeten de Cloudopslag van Microsoft Azure om klantenverslagen te halen en geproduceerde documenten op te slaan. U configureert Microsoft Azure Storage in Experience Manager Cloud Service Configuration.
...
* [&#x200B; Microsoft Azure de rekening van de Opslag &#x200B;](https://docs.microsoft.com/en-us/azure/storage/common/storage-account-create)
...
Uw Experience Manager-exemplaar is nu klaar om verbinding te maken met Microsoft Azure Storage en het te gebruiken om indien nodig inhoud op te slaan en te lezen.
...
1. Blader in Opslagconfiguratiepad naar en selecteer de Cloud Configuration die de gegevens van de Azure-opslagaccount in eigendom van de klant bevat.
...
>[!NOTE]
>
>Breng tijdens het uitvoeren van de batch geen wijzigingen aan in de overeenkomende bron- en doelmappen, de configuratie van de gegevensbron en de Microsoft Azure Cloud-configuratie.
