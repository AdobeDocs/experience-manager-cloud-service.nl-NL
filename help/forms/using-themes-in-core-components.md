...
>[!NOTE]
>
>Als uw Adaptive Forms is ingesloten in AEM Sites-pagina&#39;s, kunt u één thema voor zowel de site als de formulieren gebruiken door een Adaptief Forms-thema in te sluiten in uw sitemenu. Zie [ een Aangepast thema van Forms in een thema van AEM Sites ](/help/forms/embed-adaptive-forms-theme-in-site-theme.md) inbedden.
...
>[!NOTE]
>
>Deze stap is van toepassing wanneer u het thema als a **standalone** pakket via de front-end pijpleiding (bijvoorbeeld, een specifieke het themarepo van Forms) opstelt. Als u **** het thema van Forms in uw thema van AEM Sites in plaats daarvan inbedt, te hoeven u niet om een afzonderlijke themanaam of versie voor het vormthema te plaatsen; de naam van het plaatsthema wordt gebruikt. Zie [ een Aangepast thema van Forms in een thema van AEM Sites ](/help/forms/embed-adaptive-forms-theme-in-site-theme.md) inbedden.
...
* 5.3 [ plaats de versie Node.js aan 20 ](#53-set-the-nodejs-version-to-20-set-node)
* 5.4 [ stel de frontend pijpleiding ](#run-a-frontend-pipeline) in werking
...
##### 5.3 Stel de versie Node.js in op 20 {#set-node}

Om de versie Node.js aan 20 te plaatsen gebruikend de pijpleidingsconfiguratie:

1. Ga naar de **sectie van de Pijpleidingen** en bepaal de plaats van uw front-end pijpleiding.
2. Op de rechterkant van de pijpleiding, klik het drie-punt menu **⋯** en van dropdown, uitgezochte **Mening/geef variabelen** uit.
3. In de **dialoog van de Configuratie van Variabelen**, vul de gebieden als volgt in:
   * **NAAM** - NODE_VERSION
   * **WAARDE** - 20
   * **TOEGEPASTE STAP** - bouw
   * **TYPE** - Variabele
4. Klik **sparen** om de configuratie toe te passen.

![ pijpleidingsconfiguratie ](/help/forms/assets/pipeline-config.png)


##### 5.4 Voer de frontendleiding uit {#run-a-frontend-pipeline}
...
1. Klik op **[!UICONTROL Save]**.
   ...
   >[!NOTE]
   >
   > Om uw front-end pijpleiding te verzekeren ontbreekt niet in Cloud Manager, [ plaats de versie Node.js aan 20 ](#set-the-nodejs-vesrion-to-20).
...
* [Een Adaptief Forms-thema insluiten in een AEM Sites-thema](/help/forms/embed-adaptive-forms-theme-in-site-theme.md)
