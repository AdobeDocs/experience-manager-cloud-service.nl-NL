...
Als u **[!DNL AEM Forms]** wilt verbinden met **[!DNL Adobe Acrobat Sign]** , stelt u de software en accounts in die worden vermeld in de sectie met voorwaarden en configureert u de Adobe Sign Cloud Service in uw Forms as a Cloud Service Author- en Publish-instanties:
...
1. Een actieve [ de ontwikkelaarsrekening van Adobe Acrobat Sign ](https://acrobat.adobe.com/us/en/sign/developer-form.html).
...
![ Werkschema van de Regering van Adobe Sign ](/help/forms/assets/adobe-acrobat-sign-govt-workflow.png)
...
1. Op de as a Cloud Service auteursinstantie van Forms, navigeer aan **[!UICONTROL Tools]** ![ hammer ](assets/hammer.png) > **[!UICONTROL General]** > **[!UICONTROL Configuration Browser]**.
1. Selecteer op de pagina **[!UICONTROL Configuration Browser]** de optie **[!UICONTROL Create]** .
1. Geef in het dialoogvenster **[!UICONTROL Create Configuration]** een **[!UICONTROL Title]** voor de configuratie op, schakel **[!UICONTROL Cloud Configurations]** in en selecteer **[!UICONTROL Create]** . Het leidt tot een configuratiecontainer om Cloud Servicen op te slaan. Zorg ervoor dat de mapnaam geen ruimte bevat.
...
In de volgende sectie deelt u de instructies `re-direct URL` en `Scopes` met het Adobe Sign-team en vraagt u referenties (client-id en clientgeheim).
...
1. Open `re-direct URL` in uw browser. U creeerde en noteerde neer `re-direct URL` in de laatste stap van [ tot een omleidings URL op uw AEM instantie ](#create-a-redirect-url-for-your-aem-instance) sectie.
...
* Als u de [ Stap van het Teken in een AEMWerkschema ](/help/forms/aem-forms-workflow-step-reference.md#sign-document-step) gebruikt om een document te ondertekenen, wacht de gebarentstap op alle ondertekenaars om het document te ondertekenen, alvorens aan de volgende stap van het werkschema te werk te gaan.
