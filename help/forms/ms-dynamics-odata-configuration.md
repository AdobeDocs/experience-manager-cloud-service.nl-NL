...
description: Leer hoe u een formuliergegevensmodel maakt op basis van de entiteiten, kenmerken en services die zijn gedefinieerd in [!DNL Microsoft Dynamics] service. The Form Data Model can be used to create Adaptive Forms that interact with [!DNL Microsoft Dynamics] om bedrijfsworkflows in te schakelen.
