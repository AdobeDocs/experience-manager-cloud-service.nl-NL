...
Het klikken van de exemplaaractie verlaat automatisch de selectiewijze en maakt het deeg ![ pictogram van het Deeg ](assets/Smock_Paste_18_N.svg) {zichtbaar. Ga nu naar de gewenste omslagweg en klik het deeg ![ ](assets/Smock_Paste_18_N.svg) pictogram van het Deeg {om de gekopieerde Aangepaste Vorm te kleven.
