...
1. Gebruik een van de volgende methoden om indexen toe te voegen:
   ...
   * Implementeer de indices via een AEM. U kunt een [ AEM Archetype ](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html?lang=en) project gebruiken om een plaatsbaar AEM pakket tot stand te brengen. Gebruik de volgende steekproefcode om indexen aan een project van het type van AEM toe te voegen Archetype:
