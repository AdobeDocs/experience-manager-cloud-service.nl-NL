...
* [&#x200B; vorm de Opslag van Azure en de Verenigde Schakelaar van de Opslag voor Concepten &amp; de Portaalcomponent van Forms van de Verzending &#x200B;](#configure-azure-storage-and-unified-storage-connector-for-drafts--submissions-forms-portal-component)

### Azure Storage en Unified Storage-connector configureren voor concepten en verzendingen en Forms Portal-component

De **componenten van Concepten &amp; van Verzending** heeft een opslagopstelling voor het bewaren van en het van een lijst maken van concepten op de pagina van AEM Sites nodig. De Unified Storage Connector biedt een framework om AEM te koppelen aan externe opslag. Als u het formulier wilt opslaan als concept, moet u een Azure-opslagaccount en een toegangstoets hebben om toegang tot het [!DNL Azure] -opslagaccount te autoriseren. Als u eenmaal een Azure-opslagaccount en de toegangstoets hebt, voert u de volgende stappen uit om een Azure Storage-configuratie te maken:
...
1. Selecteer een configuratiemap om de configuratie te maken en selecteer **[!UICONTROL Create]** .
   ...
   ![&#x200B; Uitgezochte de Omslag van de Configuratie van de Opslag van Azure &#x200B;](/help/forms/assets/save-form-as-draft-select-config-folder.png)
...
1. Geef de naam van de [!DNL Azure] -opslagaccount op in de velden **[!UICONTROL Azure Storage Account]** en **[!UICONTROL Azure Access Key]** .
   ...
   ![&#x200B; de Configuratie van de Opslag van Azure &#x200B;](/help/forms/assets/save-form-as-draft-azure-storage.png)
...
1. Klik **sparen**.
   ...
   >[!NOTE]
   >
   > U kunt **[!UICONTROL Azure Storage Account]** en **[!UICONTROL Azure Access Key]** van het [&#x200B; Portaal van Microsoft Azure terugwinnen &#x200B;](https://learn.microsoft.com/en-us/azure/storage/common/storage-account-keys-manage?tabs=azure-portal).
...
Zodra u met succes de Opslag van Azure en de Verenigde Schakelaar van de Opslag voor het opslaan van de concepten en voorgelegde vormen hebt gevormd, voeg de **Concepten &amp; van de Verzending** component op de pagina van AEM Sites toe.
