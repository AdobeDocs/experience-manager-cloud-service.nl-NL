---
title: Hoe kunnen we variabelen toevoegen aan AEM Workflow-stappen?
...
In AEM Workflow-modellen kunt u:
...
De volgende video laat zien hoe u variabelen kunt maken, instellen en gebruiken in AEM Workflow-modellen:
...
U maakt variabelen aan de hand van de sectie Variabelen die beschikbaar is in de assistent van het workflowmodel. AEM Workflow-variabelen ondersteunen de volgende gegevenstypen:
...
1. Voor een instantie van AEM, navigeer aan het Pictogram van de Hammer van Hulpmiddelen ![&#x200B; > Werkschema > Modellen.](assets/hammer-icon.svg)
...
Voor meer voorbeelden bij het gebruiken van variabelen in [!DNL AEM Forms] stappen van het Werkschema, zie [&#x200B; Variabelen in de werkschema&#39;s van AEM &#x200B;](https://helpx.adobe.com/experience-manager/kt/forms/using/authoring_variables_in_aem_forms-workflow1.html).
