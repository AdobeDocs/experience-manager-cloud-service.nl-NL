...
* Webcompressie inschakelen. Hiermee verkleint u de grootte van de aanvragen en reacties die afkomstig zijn van een formulier. <!-- For details, see [Performance tuning of AEM Forms Server](https://helpx.adobe.com/nl/aem-forms/6-3/performance-tuning-aem-forms.html)-->
