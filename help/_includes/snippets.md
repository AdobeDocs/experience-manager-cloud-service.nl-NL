...
## Proefversies zonder koptekst (programma is verlopen) {#headless-trials-promotion}
...
* [Verzenden met gebruik van formuliergegevensmodel](/help/forms/integrate-adaptive-form-with-fdm.md)
...
<table>
  ...
  <tr>
   ...
   <tr>
    <td>ECMAScript-versieondersteuning</td>
    <td>Ondersteunt alleen ES5 JavaScript-functies.</td>
    <td>Ondersteunt moderne JavaScript-functies (bijvoorbeeld <code>let</code> , pijlfuncties) binnen aangepaste functies.</td>
   </tr>
   </tr>
   <tr>
...
## Universal Editor Headless-verificatie {#ue-headless-auth}
...
## PWA Deprection {#pwa-deprecation}
