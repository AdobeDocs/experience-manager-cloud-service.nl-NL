...
>
>Overschrijvingen worden echter vaak gedefinieerd onder `/apps`, aangezien de beste praktijken in AEM as a Cloud Service is aanpassingen te bepalen onder `/apps`; omdat je niets mag veranderen onder `/libs`.
