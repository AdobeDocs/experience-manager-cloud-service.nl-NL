...
1. Installeer de hulpmiddelen van Adobe I/O CLI volgens deze [ procedure ](https://developer.adobe.com/runtime/docs/guides/tools/cli_install/).
1. Installeer de Adobe I/O CLI-tools AEM RDE-insteekmodule:
