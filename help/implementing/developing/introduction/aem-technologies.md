...
Deze architectuur laat u het Verkopen met toepassing-specifieke modules uitbreiden. Sling, en daarom AEM, gebruikt de [&#x200B; implementatie van de Felix van 0&rbrace; Apache &lbrace;van OSGi. &#x200B;](https://felix.apache.org/documentation/index.html) Het zijn beide inzamelingen van bundels OSGi die binnen een kader OSGi lopen.
