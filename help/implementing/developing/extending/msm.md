...
1. In CRXDE Lite, selecteer uw [ knoop van de Configuratie van de Output 0} {, bijvoorbeeld, ](#create-the-rollout-configuration).`/apps/msm/myproject/rolloutconfigs/myrolloutconfig`
