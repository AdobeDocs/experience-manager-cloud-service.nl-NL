...
1. De gemaakte `wknd-spa/components/imagecard` component aan de toegestane componenten voor de containercomponent [in de paginasjabloon.](/help/sites-cloud/authoring/features/templates.md)
