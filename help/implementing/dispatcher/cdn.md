...
### Beperking van het verkeer {#restricting-traffic}
...
Deze CDN-configuratie van de klant wordt ondersteund voor de publicatielaag en de voorvertoningslaag, maar niet vóór de auteurslaag.
...
#### Omleiden naar het eindpunt van de publicatieservice {#redirect-publish}
...
#### Fout 421 Verkeerd omleiden {#error-421}
...
#### Te veel omleidingen {#redirect-loop}
