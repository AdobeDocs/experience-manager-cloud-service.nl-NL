...
* Het [ dashboard van de Vergunning ](/help/implementing/cloud-manager/license-dashboard.md) is nu toegankelijk via een verschillend ingangspunt in de linkernavigatie [.](/help/implementing/cloud-manager/navigation.md)
