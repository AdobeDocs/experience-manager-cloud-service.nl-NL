...
De releasedatum voor Cloud Manager release 2024.5.0 in AEM as a Cloud Service is 9 mei 2024. De volgende release is gepland voor 6 juni 2024.

## Wat is er nieuw? {#what-is-new}

* Het [ dashboard van de Vergunning ](/help/implementing/cloud-manager/license-dashboard.md) is nu toegankelijk via een verschillend ingangspunt in de linker[ navigatie ](/help/implementing/cloud-manager/navigation.md).
