...
* Cloud Manager bevestigt nu de vervaldata niet alleen voor het belangrijkste [ certificaat, ](/help/implementing/cloud-manager/managing-ssl-certifications/introduction-to-ssl-certificates.md) maar ook voor middencertificaten.
