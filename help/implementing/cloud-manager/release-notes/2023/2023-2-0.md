...
* API veranderingen werden aangebracht om [ RDEs te steunen.](https://developer.adobe.com/experience-cloud/cloud-manager/reference/api/#tag/Rapid-Development-Environments)
* API staat nu terugwinning van [ uitvoeringsartefacten toe.](https://developer.adobe.com/experience-cloud/cloud-manager/reference/api/#tag/Execution-Artifacts)
