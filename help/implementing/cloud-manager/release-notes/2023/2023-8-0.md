...
* Wanneer een certificaat verloopt, worden de domeinnamen en IP allow-lists verbonden aan het certificaat niet meer verwijderd uit CDN.
   ...
   * [ UI van Cloud Manager ](/help/implementing/cloud-manager/managing-ssl-certifications/introduction.md) zal zichtbaardere vooruitgangswaarschuwingen verstrekken dat het SSL certificaat op het punt staat te verlopen.
