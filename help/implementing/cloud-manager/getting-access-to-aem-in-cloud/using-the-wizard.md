...
1. Zodra de programmaopstelling volledig is, heb toegang tot het **Overzicht** scherm van uw programma en zie **Tak &amp; de kaart van call-to-action van het Project** bij de bovenkant creëren.
   ...
   ![ de zorg van Call-to-action voor de tovenaar ](assets/create-wizard1.png)
...
A **kaart van de Making van het 0} Project vervangt nu de** Tak &amp; van het Project **kaart van call-to-action als bovenkant van het** Overzicht van het Programma **scherm.**
