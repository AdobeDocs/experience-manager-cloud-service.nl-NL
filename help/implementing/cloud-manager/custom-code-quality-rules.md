...
Het Experience Manager API-oppervlak wordt voortdurend herzien om te bepalen voor welke API&#39;s het gebruik moet worden gestopt. Deze API is vervangen en gemarkeerd met een verwijderingsdatum.

Hoe dichter de verwijderingsdatum wordt, des te hoger is de ernst van het overtreden van deze regel. Het gebruik van een dergelijke API moet worden vervangen door een veilig alternatief.
