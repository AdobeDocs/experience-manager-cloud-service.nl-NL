...
### Gebruik geen API&#39;s die zijn vervangen door Experience Manager {#sonarqube-aem-api-deprecated}

* **Sleutel**: java :S1874
* **Type**: `Vulnerability` of `Bug` /Cloud Service Verenigbaarheid
* **Ernst**: Info, Klein, of Belangrijk
* **sinds**: Versie 2026.1.0

Het Experience Manager API-oppervlak wordt voortdurend herzien om te bepalen voor welke API&#39;s het gebruik moet worden gestopt. Deze API&#39;s zijn vervangen en gemarkeerd met een verwijderingsdatum.

Hoe dichter de verwijderingsdatum wordt, des te hoger is de ernst van het overtreden van deze regel. Het gebruik van dergelijke API&#39;s moet worden vervangen door een veilig alternatief.

Gelieve te verwijzen [ dit artikel ](/help/release-notes/deprecated-removed-features.md#aem-apis) voor begeleiding op hoe te om gebruik van afgekeurde APIs te verwijderen.
...
[ de Moderniseringshulpmiddelen van Experience Manager ](https://opensource.adobe.com/aem-modernize-tools/) kunnen deze omzetting vergemakkelijken.
