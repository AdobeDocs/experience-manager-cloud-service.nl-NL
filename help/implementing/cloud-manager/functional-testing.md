...
De tests worden verpakt in een Docker-afbeelding - ontworpen om zo vluchtig mogelijk te zijn (met ondersteuning voor Cypress, Selenium, Java, Javascript, enz.). Ze hebben dezelfde kenmerken en doeleinden als de aangepaste functionele tests.
