...
Om milieu variabelen toe te voegen, bij te werken of te schrappen, moet u een lid van de [**rol** zijn van de Manager van de Plaatsing 0&rbrace;.](/help/onboarding/cloud-manager-introduction.md#role-based-premissions)
...
1. Voor de detailpagina van het milieu, klik de **Configuratie** tabel.
1. Klik ![&#x200B; toevoegen/bijwerken - voeg cirkelpictogram &#x200B;](https://spectrum.adobe.com/static/icons/workflow_18/Smock_AddCircle_18_N.svg) toe **toevoegen/bijwerken**.
1. In het **de dialoogvakje van de Configuratie van het Milieu 1&rbrace;, klik** Ellipse - Meer pictogram ![&#x200B; in de laatste kolom van de rij van de variabele u wilt veranderen.](https://spectrum.adobe.com/static/icons/workflow_18/Smock_More_18_N.svg)
