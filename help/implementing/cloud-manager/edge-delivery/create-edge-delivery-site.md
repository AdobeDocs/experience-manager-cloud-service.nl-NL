...
1. In **creeer de plaats van Edge Delivery** dialoogdoos, op het **3} tekstgebied van de Naam van het Project {, ga de naam van uw plaats in, dan klik** creeer plaats nu **.**
...
1. Voer op de Edge Delivery-pagina een van de volgende handelingen uit:
   ...
   | --- | --- |
   | GitHub-opslagplaats van een site | <ul><li>In het **de plaatsen van Edge Delivery** lijstvakje, onder de **3} kolomrubriek van de Bewaarplaats {, klik URL van de plaats u enkel creeerde.**<br> u kunt worden vereist om binnen aan GitHub met uw gebruikersbenaming of e-mailadres en uw wachtwoord te ondertekenen.</li> |
