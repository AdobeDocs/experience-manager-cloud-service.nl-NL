...
Met de functie **`Manage Access Tokens`** kunt u tokens nu efficiënter beheren. U kunt tokens bekijken, anders noemen of verwijderen die aan gesteunde externe leveranciers van het Git, met inbegrip van de Onderneming GitHub, GitLab, Bitbucket, en Azure DevOps worden aangesloten.
...
1. In het **`Delete Access Token`** dialoogvakje, klik **Schrapping** om het teken permanent te verwijderen.
