...
|---|---|---|---|---|
| [ Klassieke Levering van AEM ](/help/sites-cloud/authoring/author-publish.md) | [!BADGE  Beschikbaar ]{type=Positive} | Aanbevolen voor gebruik met de Core Components | [!BADGE  niet beschikbaar ]{type=Negative} | Klassieke AEM-pagina&#39;s zijn meestal gebaseerd op verschillende specifieke functies van de paginaeditor die moeilijk kunnen worden gerepliceerd zoals deze in de Universal Editor worden gebruikt. |
...
Hoewel de Universele Redacteur het uitgeven voor klassieke AEM pagina&#39;s (b.v. gebouwd met de Componenten van de Kern) technisch kan toelaten, baseren deze plaatsen zich typisch op verscheidene de redacteur-specifieke eigenschappen van de Pagina, zoals het Systeem van de Stijl, ReactieNet, Bewerkbare Malplaatjes, en douane Javascript binnen dialogen.
