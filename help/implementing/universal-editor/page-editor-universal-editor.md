...
| Eigenschappen voor meerdere velden | [!BADGE  Beschikbaar ]{type=Positive} |  | [!BADGE  Beschikbaar ]{type=Positive} |  |
...
| [ Diff Mening ](/help/sites-cloud/authoring/sites-console/page-diff.md) | [!BADGE  Beschikbaar ]{type=Positive} |  | [!BADGE  gedeeltelijk Beschikbaar ]{type=Caution} | Beschikbaar voor Edge Delivery Services-gebruiksscenario&#39;s, maar zonder kop |
| [ TimeWarp ](/help/sites-cloud/authoring/sites-console/page-versions.md#timewarp) | [!BADGE  Beschikbaar ]{type=Positive} |  | [!BADGE  niet beschikbaar ]{type=Negative} | Gepland, nog beschikbare versies in de Console van Plaatsen |
