...
De klanten die van de Uitgebreide Veiligheid (vroeger genoemde Bescherming WAF-DDoS) of Uitgebreide Veiligheid voor Gezondheid (vroeger genoemd Uitgebreide Veiligheid) aanbieden kunnen een speciale categorie van de regels van de verkeersfilter ook vormen genoemd *de regels van de het verkeersfilter van 0} WAF (of* regels van WAF *voor kort) die één of meerdere* vlaggen van WAF [ van verwijzingen voorzien.](#waf-flags-list)
