...
<tbody>
  ...
  <tr>
    <td></td>
    <td>Als IP niet in de <i> 1} waaier van het gatewayadres van VPN {valt en de cliënt verbindt met </i> env variabele gebruikend <code>AEM_PROXY_HOST</code> gedeclareerd in de <code>portOrig</code> API parameter<code>portForwards</code></td>
    <td>Alle</td>
    <td>Door specifieke uitgang IP</td>
    <td></td>
  </tr>
