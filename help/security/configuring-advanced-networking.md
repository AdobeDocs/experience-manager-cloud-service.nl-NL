...
<tbody>
  ...
  <tr>
    <td></td>
    <td>Als IP niet in de <i> 1&rbrace; waaier van het gatewayadres van VPN &lbrace;valt en de cliënt verbindt met </i> env variabele gebruikend <code>AEM_PROXY_HOST</code> gedeclareerd in de <code>portOrig</code> API parameter<code>portForwards</code></td>
    <td>Alle</td>
    <td>Door specifieke uitgang IP</td>
    <td></td>
  </tr>
...
<tbody>
  <tr>
    ...
    <td>Het specifieke IP adres van de uitgang voor verkeer dat naar Internet eerder dan door privé netwerken gaat.</td>
  </tr>
  <tr>
