...
![ Configuratie van de Diensten van de Wolk van CIF ](/help/commerce-cloud/assets/cif-cloud-service-config.png)
...
Voor complexere montages, die veelvoudige de plaatsstructuren gebruiken van AEM die met verschillende handelscatalogi worden gecombineerd zien het [&#128279;](configuring/multi-store-setup.md) leerprogramma van de Opstelling van de multi-Opslag van 0&rbrace; Commerce &lbrace;.
