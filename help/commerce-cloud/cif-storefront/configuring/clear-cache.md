...
| `cacheNames` | Deze waarden worden gedefinieerd onder de corresponderende CIF GraphQL client configuration factory >> Corresponding StorePath GraphQL configuration >> GraphQL cache configuration | Array | Nee | |
...
### Voorbeeld-API-aanvraag {#sample-request}
