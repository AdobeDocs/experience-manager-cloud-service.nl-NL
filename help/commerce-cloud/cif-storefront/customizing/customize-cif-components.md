...
1. Wijzig `productteaser.html` zodat u de methode `isEcoFriendly` kunt aanroepen die in de vorige exercitie is geïmplementeerd:
   ...
   Meer informatie over `data-sly-test` en andere het blokverklaringen van HTML kan in [ de Specificatie van HTML worden gevonden.](https://experienceleague.adobe.com/docs/experience-manager-htl/content/specification.html)
