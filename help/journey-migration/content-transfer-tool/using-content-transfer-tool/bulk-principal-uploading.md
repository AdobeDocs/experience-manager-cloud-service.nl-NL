...
* Houd er rekening mee dat er verschillende manieren zijn om gebruikers en groepen te maken in IMS.  Zie [ Steun IMS voor Adobe Experience Manager as a Cloud Service ](/help/security/ims-support.md) om over alle beschikbare opties te leren.  Alleen de Admin Console-methoden voor bulkupload worden hier beschreven
* Er zijn drie types van Identiteit mogelijk in IMS: **Adobe ID**, **Enterprise ID**, en **Federated ID**. De instructies op deze pagina worden verstrekt voor **slechts Adobe ID**.  Als u Enterprise ID of Federated ID moet gebruiken, gelieve te verwijzen naar de volledige [ documentatie van Admin Console ](https://helpx.adobe.com/nl/enterprise/using/admin-console.html) en ook de specifieke documentatie voor [ de BulkGroep van Admin Console uploadt ](https://helpx.adobe.com/enterprise/using/user-groups.html) en [ BulkGebruiker van Admin Console uploadt ](https://helpx.adobe.com/enterprise/using/bulk-upload-users.html).  De specificaties voor de uploadbestanden verschillen enigszins voor deze twee identiteitstypen
...
* Het bulkgebruikersbestand bewerken
