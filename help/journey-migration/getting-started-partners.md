...
1. [Inhoud overbrengen](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/content-transfer-tool.html?lang=en#migration) : wordt gebruikt om bestaande inhoud te verplaatsen van een bron AEM instantie (on-premise of AMS) naar de AEM Cloud Service-doelinstantie.
2. [Pakketbeheer](https://experienceleague.adobe.com/docs/experience-manager-65/administering/contentmanagement/package-manager.html?lang=en#package-manager) : wordt gebruikt voor het importeren en exporteren van muteerbare inhoud van de opslagplaats.
