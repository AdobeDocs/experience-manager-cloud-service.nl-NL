...
description: Begin hier voor een begeleide reis door uw AEM Sites-inhoud te vertalen met AEM krachtige vertaalhulpmiddelen.
index: true
hide: false
hidefromtoc: false
...
Begin hier voor een begeleide reis door uw AEM Sites-inhoud te vertalen met AEM krachtige vertaalhulpmiddelen.
...
Als u al bekend bent met AEM Sites en uw vertaalvereisten, hebt u wellicht al de grondkennis van deze reis. Als dat het geval is, kunt u overwegen te verwijzen naar onze technische documentatie die is gekoppeld onder de [Aanvullende bronnen hieronder.](#additional-resources)
...
| 1 | [Meer informatie over de inhoud van sites en hoe u deze vertaalt in AEM](learn-about.md) | Leer concepten van sites en de theorie van AEM vertaling. |
| 2 | [Aan de slag met AEM Sites-vertaling](getting-started.md) | Leer hoe u de inhoud van uw sites kunt ordenen en hoe AEM vertaalgereedschappen werken. |
...
| 5 | [Inhoud vertalen](translate-content.md) | Gebruik de vertaalschakelaar en de regels om uw plaatsinhoud te vertalen. |
...
U bent nu klaar om aan de slag te gaan met de vertaalreis van uw Adobe sites. We raden u aan door te gaan naar het volgende deel van de reis en het artikel te lezen [Meer informatie over de inhoud van sites en hoe u deze vertaalt in AEM](learn-about.md)
