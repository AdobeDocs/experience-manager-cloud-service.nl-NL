...
Gebruikend geheim-type milieu (of pijpleiding) variabelen, is het mogelijk voor [ geheime eigenschappen ](#secret-env-vars) per milieu te variëren, zoals geïllustreerd door de `${{SPLUNK_TOKEN}}` verwijzing
