...
Als alle steunkaartjes, zal het in de [ Gevallen van de Steun van Adobe Admin Console tabel ](https://helpx.adobe.com/nl/enterprise/using/support-for-enterprise.html) verschijnen, waar u het kunt volgen en extra commentaren toevoegen.
...
| Pagina&#39;s bevatten veel knooppunten | Proactief | Het totale aantal knooppunten op een pagina verminderen. Verwijs naar [ documentatie van de Complexiteit van de Pagina ](https://experienceleague.adobe.com/nl/docs/experience-manager-pattern-detection/table-of-contents/pcx) | |
| Groot aantal actieve workflowinstanties | Proactief | Beëindig actieve workflows die niet meer nodig zijn. Leer hoe te [ een zuiveringsbaan ](https://experienceleague.adobe.com/nl/docs/experience-manager-cloud-service/content/operations/maintenance) vormen |               |
...
| Ontbrekende JCR-inhoud | Proactief | Voeg het ontbrekende knooppunt voor JCR-inhoud toe. Verwijs naar [ de documentatie van de Validator van de Inhoud van Assets ](https://experienceleague.adobe.com/nl/docs/experience-manager-pattern-detection/table-of-contents/acv) | |
| Voltooide workflows niet gewist | Proactief | Minimaliseer het aantal workflowinstanties en verbeter de prestaties door workflowinstanties van meer dan 90 dagen oud te wissen. Leer hoe te [ om onderhoudstaken ](https://experienceleague.adobe.com/nl/docs/experience-manager-cloud-service/content/operations/maintenance) te vormen | |
| Ontbrekend Sling-brontype in pagina | Proactief | Ontbrekend knooppunt voor Sling-resource toevoegen. Verwijs naar [ de documentatie van de Validator van de Inhoud van Assets ](https://experienceleague.adobe.com/nl/docs/experience-manager-pattern-detection/table-of-contents/acv) | |
| Langzame query | Proactief | Repareer langzame vragen door correcte indexdefinities te bepalen zoals die door het [ JCQ vraagbedriegblad ](https://experienceleague.adobe.com/docs/experience-manager-65/assets/JCR_query_cheatsheet-v1.1.pdf?lang=nl-NL) worden voorgesteld | |
| Query zonder index | Proactief | Vermijd uitvoerend vraag die geen index gebruikt - [ verbinding aan het Indexeren documentatie ](https://experienceleague.adobe.com/nl/docs/experience-manager-cloud-service/content/operations/indexing) | |
