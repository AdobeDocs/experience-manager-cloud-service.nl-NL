...
+ AI-assistent {#ai-assistant-in-aem}
...
+ Generatieve AI {#generative-ai}
   ...
   + [AI Assistant in AEM - Instellen](/help/implementing/cloud-manager/aem-ai-assistant-admin.md)
   + [AI Assistant in AEM (Beta)](/help/implementing/cloud-manager/aem-ai-assistant.md)
   + [AI Assistant in AEM Forms (Forms Experience Builder) (Vroege adopter)](/help/edge/docs/forms/forms-ai-assistant.md)
   + [AI Assistant in AEM Forms - Promptbibliotheek](/help/edge/docs/forms/ai-assistant-prompt-library.md)
   + [AI Assistant in AEM Forms - Aan de slag](/help/edge/docs/forms/forms-ai-assistant-getting-started.md)
