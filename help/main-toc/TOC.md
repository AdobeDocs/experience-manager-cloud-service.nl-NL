...
+ Edge Delivery Services {#edge-delivery}
   ...
   + Forms samenstellen {#build-forms}
      ...
      + WYSIWYG Authoring {#universal-editor}
         ...
         + [De Gebruikers van de gids na Verzending: Vorm Omleiding en Dank u Berichten in Universele Redacteur](/help/edge/docs/forms/universal-editor/configure-thankyou-message.md)
         ...
         + [Prefill-service configureren: volledige stapsgewijze handleiding voor het configureren van Prefill-service](/help/edge/docs/forms/universal-editor/prefill-form.md)
         + [Herbruikbare, modulaire en standalone segmenten: formulierfragmenten maken en gebruiken in formulieren](/help/edge/docs/forms/universal-editor/creating-form-fragments.md)
