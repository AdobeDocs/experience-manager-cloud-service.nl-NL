...
+ Generatieve AI {#generative-ai}
   ...
   + [AEM AI Assistant (beperkte Beta)](/help/implementing/cloud-manager/aem-ai-assistant.md)
   + [AEM Forms AI Assistant (Forms Experience Builder) (Vroege adopter)](/help/edge/docs/forms/forms-ai-assistant.md)
