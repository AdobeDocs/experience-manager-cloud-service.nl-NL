...
+ Inhoud en Commerce {#content-and-commerce}
   ...
   + AEM Storefront {#storefront}
      ...
      + Beheer {#administering}
         ...
         + [Cache voor componenten en GraphQL wissen](/help/commerce-cloud/configuring/clear-cache.md)
      + Ontwikkelen {#developing}
         ...
         + [JSON-LD-metagegevens](/help/commerce-cloud/customizing/json-ld.md)
