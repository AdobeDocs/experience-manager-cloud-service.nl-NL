...
+ AI in AEM {#ai-in-aem}
   ...
   + AEM Business Agents {#business-agents}
      ...
      + Productieagent {#production}
         + [Overzicht](/help/ai-in-aem/agents/production/overview.md)
         + [Interactieve communicatie creatie Vaardigheid](/help/ai-in-aem/agents/production/communications-creation.md)
      ...
      + Content Optimization Agent {#content-optimization}
         + [De agent voor het optimaliseren van inhoud gebruiken](/help/ai-in-aem/agents/content-optimization/using.md)
      + Detectieagent {#discovery}
         + [Detectieagent gebruiken](/help/ai-in-aem/agents/discovery/using.md)
