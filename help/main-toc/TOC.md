...
+ Generatieve AI {#generative-ai}
   ...
   + [De AI-assistent in AEM configureren](/help/implementing/cloud-manager/aem-ai-assistant-admin.md)
...
+ Implementatie {#implementing}
   ...
   + Cloud Manager gebruiken {#using-cloud-manager}
      ...
      + Uw code beheren {#managing-code}
         ...
         + [Configuratie van GitHub-controle](/help/implementing/cloud-manager/managing-code/github-check-config.md)
