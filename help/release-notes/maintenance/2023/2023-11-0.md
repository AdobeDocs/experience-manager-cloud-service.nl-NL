---
title: Nota's van de Versie van het onderhoud van  [!DNL Adobe Experience Manager]  as a Cloud Service verbonden aan 2023.11.0 eigenschapactivering.
description: Nota's van de Versie van het onderhoud van  [!DNL Adobe Experience Manager]  as a Cloud Service verbonden aan 2023.11.0 eigenschapactivering.
...
In het volgende gedeelte worden de opmerkingen bij de technische release voor de onderhoudsreleases van Experience Manager as a Cloud Service beschreven die zijn gekoppeld aan activering van de functie 2023.11.0.
...
2023.11.0 Activering van de functie biedt de volledige functie die is ingesteld voor deze onderhoudsrelease. Zie [ Experience Manager geeft Roadmap ](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap.html) voor meer informatie vrij.

### Verbeteringen {#enhancements-14227}

* ASSETS-29631: Assets Cloud: Gebruik dam :roles voor veilige levering/onderzoek.
...
* ASSETS-24739: schakel het Eindpunt voor aangepaste actie Frame.io uit bij Publiceren.
...
* SITES-16207: Inhoudsfragmenten: De bewerking POST/adobe/sites/cf/models retourneert twee verschillende statuscodes voor OK.
...
* SITES-16103: Experience Fragments: De doelopties worden niet weergegeven onder Cloud Services vanwege een consolefout.
...
* ASSETS-28634: In het veld Omnresearch in Adobe-bestanden worden de gegevens van middelen niet automatisch toegevoegd.
...
* ASSETS-29106: Weergave op Adobe-bestand genereert een fout op AEM met Unified Shell-functionaliteit.
...
* ASSETS-29631: Gebruik dam :roles voor veilige levering/onderzoek.
* ASSETS-29689: dc :roles (en de nieuwe bezitsdam :roles) zou van AEM kant moeten worden gefiltreerd.
...
* ASSETS-30167: HTML for adobe_dam :restrictions breekt na het uploaden van activa.
