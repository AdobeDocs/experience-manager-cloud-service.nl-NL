---
title: Nota's van de Versie van het onderhoud van  [!DNL Adobe Experience Manager]  as a Cloud Service verbonden aan 2023.7.0 eigenschapactivering.
description: Nota's van de Versie van het onderhoud van  [!DNL Adobe Experience Manager]  as a Cloud Service verbonden aan 2023.7.0 eigenschapactivering.
...
In het volgende gedeelte worden de opmerkingen bij de technische release voor de onderhoudsreleases van Experience Manager as a Cloud Service beschreven die zijn gekoppeld aan activering van de functie 2023.7.0.
...
- DXML-10141: AEM Guides: optie om op microservice gebaseerde publicaties te gebruiken voor PDF (native &amp; DITA-OT), HTML en aangepaste voorinstellingstypen
...
- SKYOPS-57146: Oplossing voor een patstelling bij AEM-opstarten
...
- FORMS-5054: Toegevoegde steun voor alle [ beelden ](https://opensource.adobe.com/acrobat-sign/acrobat_sign_events/webhookeventsagreements.html) die door het Teken van Adobe worden gesteund.
...
- FORMS-8500: HTML5 Forms kan niet worden geopend in de Microsoft® Edge-browser waarvoor de optie IE-modus is ingeschakeld.
...
- FORMS-8668: Tijdens het weergeven van een PDF Preview van een formulier, wordt een niet-vereiste Java™ stackdump weergegeven in de foutlogboeken. Er zijn echter geen problemen met de weergave van het formulier.
