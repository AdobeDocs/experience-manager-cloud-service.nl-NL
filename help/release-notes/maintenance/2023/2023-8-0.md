---
title: Nota's van de Versie van het onderhoud van  [!DNL Adobe Experience Manager]  as a Cloud Service verbonden aan 2023.8.0 eigenschapactivering.
description: Nota's van de Versie van het onderhoud van  [!DNL Adobe Experience Manager]  as a Cloud Service verbonden aan 2023.8.0 eigenschapactivering.
...
In het volgende gedeelte worden de opmerkingen bij de technische release voor de onderhoudsreleases van Experience Manager as a Cloud Service beschreven die zijn gekoppeld aan activering van de functie 2023.8.0.
...
- CQ-4354191: Werkstromen - De lancering van de Douane kan vele tijden wegens replicatiemetagegevens teweegbrengen aanwezig op nt :unstructured knopen (alternerende actie: updatedeskundigen om replicatiemetasteigenschappen uit te sluiten om overlapping te vermijden).
...
| AEM-kerncomponenten | Versie 2.23.2 | [ AEM WCM de Componenten van de Kern ](https://github.com/adobe/aem-core-wcm-components) |
...
- ASSETS-8715: Voegt ongeldige controle/niet ongeldige controle voor het bezit &quot;jcr :content/metadata/dam :status&quot; toe
- GRANITE-45138: Verwijdert eigenschapindex uit de voorspelde tags dynamic boost, eigenschap
- ASSETS-17614: Voegt identiteitskaart Scene7 als geïndexeerde bezit toe (ongeldige controle en niet ongeldige toegelaten controle)
...
- ASSETS-25473: Het probleem waarbij de optie Snel publiceren zichtbaar was voor gebruikers zonder replicatiemachtiging, is opgelost.
...
- ASSETS-26576: Probleem verholpen met Dropbox Import waarbij de onjuiste maphiërarchie werd gemaakt
...
- GRANITE-46601: Oplossing voor een probleem waardoor Quickstart SDK niet kon starten op 11.0.20 JDK
