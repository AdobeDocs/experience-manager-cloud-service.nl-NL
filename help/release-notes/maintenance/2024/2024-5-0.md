...
* SITES-19614: [ Xwalk ] paginering van het Spreadsheet/oneindige rol.
...
* SITES-20405: [ Xwalk ] Steun mimeType voor gebied het doen ineenstorten.
...
* SITES-20653: [ Xwalk ] voeg experiment-begin-datum en -eind-date toe.
* SITES-20656: [ BE ] verstrekt optie om geval aan te passen wanneer het vervangen van een koord.
* SITES-2066: [ Xwalk ] experiment zou per gebrek op auteursrecht moeten worden uitgezet.
...
* SITES-21043: ][launches] de verbeteringen van de 1} zijhavenprestaties van 0 CF aan Cloud Service.[
* SITES-21044: [ CF ][launches] zij-haven async geeft nuttige ladingsimplementatie aan Cloud Service uit.
* SITES-21550: [ Xwalk ] de meta-gegevens van de Douane: aantal, datum, datetime, tijdgebieden.
...
* SITES-1954: [ Xwalk ] Redacteur van het Werkblad: Kan geen cel leegmaken.
...
* SITES-20364: 302 leidt niet Werken met kiezer in URL.
* SITES-20547: Afgeknot paden in lijst met uitgesloten paden van Live kopie op AEM as a Cloud Service.
* SITES-20401: {de meta-gegevens van de 1} Sectie van 0} Xwalk {steunen multi-value geen eigenschappen.[]
* SITES-20496: [ Xwalk ] Geen eigenschappen optie wanneer het selecteren van spreadsheet in plaats admin.
...
* ASSETS-32321: Workflowresolutie Post-Verwerking mislukt als het subknooppunt &#39;jcr:content&#39; in de bovenliggende map ontbreekt.
...
* ASSETS-35226: Post-Verwerkingsworkflow wordt niet opgelost als dit is opgegeven in de DAM-hoofdmap.
