...
De activering van de 2024.8.0-functie biedt de volledige functie die is ingesteld voor deze onderhoudrelease. Zie [ Experience Manager geeft Roadmap ](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap) voor meer informatie vrij.
...
* SITES-12209 - verbeter de prestaties van de Redacteur van het Beleid door cq :policy aan index toe te voegen.
...
* FORMS-14327 - de Dienst APIs van Forms: Extraheer gegevens :- geeft 500 reactiecode wanneer niet-interactieve pdf in input wordt verstrekt.
