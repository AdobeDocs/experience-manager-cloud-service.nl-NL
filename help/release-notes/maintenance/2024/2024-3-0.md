---
title: Nota's van de Versie van het onderhoud van  [!DNL Adobe Experience Manager]  as a Cloud Service verbonden aan 2024.3.0 eigenschapactivering.
description: Nota's van de Versie van het onderhoud van  [!DNL Adobe Experience Manager]  as a Cloud Service verbonden aan 2024.3.0 eigenschapactivering.
...
In het volgende gedeelte worden de opmerkingen bij de technische release voor de onderhoudsreleases van Experience Manager as a Cloud Service beschreven die zijn gekoppeld aan activering van de functie 2024.3.0.
...
| AEM-kerncomponenten | Versie 2.2.4 | [ AEM WCM de Componenten van de Kern ](https://github.com/adobe/aem-core-wcm-components) |
...
* SITES-8836 - Inhoudsfragmenten - OpenAPI - Controlevlak - GET References - Bovenliggende referenties van een fragment ophalen (door UUID)
...
* SITES-17768 - Inhoudsfragmenten - GraphQL API - Dynamische media-URL voor afbeeldingen toegankelijk maken via _dmS7Url
...
* SITES-15430 - Universal Editor - Universal Editor onder AEM-domein
* CQ-4344966 - WCM - Vertaling - Basiskader creëren voor structurele update van sites en bestaande bijwerken voor middelen
* CQ-4347312 - WCM - Vertaling - creeer werkschema om &quot;cq :translationsourcejcruuid&quot;in bestaande bron en taalexemplaren te associëren
* CQ-4354509 - WCM - Vertaling - publiceer de Gebeurtenissen van de Baan van de Vertaling [ OSGi EventAdmin ]
* SITES-16318 - Crosswalk - Op AEM gebaseerde authoring met Edge Delivery Services
* FORMS-9889: De gebruiker kan de configuratie van de POST URL en van de Wolk terwijl het vormen van de Verzendactie voor voorleggen aan het Eindpunt van REST toevoegen
...
* SITES-12460 - Campagne-integratie - Campagne/AEM Cloud Service Integration verbroken
...
* SITES-16733 - MSM - Actieve exemplaren - de pagina van de index van de Vervaging kan niet worden uitgerold wanneer rep :policy op knoop wordt toegepast
...
* CQ-4355289 - WCM - Vertaling - Slechts de eerste 40 elementen worden getoond in de Diensten van de Wolk van de Vertaling
...
* FORMS-12938: De HTML5-formulieren werken niet of laden niet correct in de Microsoft Edge-browser met IE-compatibiliteitsmodus
...
* FORMS-13789: wanneer een gebruiker meerdere PDF&#39;s probeert te genereren, mislukt de uitvoerbatch-API
* FORMS-11483: wanneer een gebruiker PDF omzet in PDF/A-2B of PDF/A-3B, wordt geen validatiefout weergegeven
* FORMS-10501: Wanneer een gebruiker HSM aanroept, worden de documenten gecertificeerd, maar wordt LTV niet ingeschakeld
* FORMS-11546: Wanneer een formulierauteur herhaalde deelvensters in een adaptieve vorm gebruikt, ontbreekt het kenmerk ARIA in de HTML-codes. Hierdoor wordt de toegankelijkheid van herhaalde deelvensters van het adaptieve formulier verbeterd
...
* SITES-17934 - Inhoudsfragmenten - Voorvertoning mislukt vanwege DoS-bescherming voor grote boomstructuur met fragmenten. Zie [ Artikel van de Kennisbank ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-23945).
...
Voor volledige lijst van verhogingen in AEM Guides, gelieve te verwijzen: [ wat in AEM Guides ](https://experienceleague.adobe.com/docs/experience-manager-guides/using/release-info/release-notes/cloud-release-notes/2024-releases/2402-release/whats-new-2024-2-0.html?lang=en#release-info) nieuw is
...
* ASSETS-26842: &quot;Firefly&quot;-tekst bijwerken naar &quot;App Builder&quot; in verwerkingsprofiel.
...
* ASSETS-31405: InDesign-serververwerking mislukt voor grote InDesign-lay-outs.
...
* ASSETS-34684: Verwerk multivalue dc :title in de inhoudsstructuur.
...
* GRANITE-47995: De verrichtingen van de schrapping kunnen wegens conflicten met &quot;cq :isDelivered&quot;bezit ontbreken.
* GRANITE-48079: Schakel POST-aanvragen voor online OAuth-tokenvalidatie in.
...
* GUIDES-14943: In Native PDF-publicaties werken aangepaste kenmerken binnen voorinstellingen voor voorwaarden niet voor native PDF-publicatie.
* GUIDEN-15085: In de Native publicatie van PDF worden de belangrijkste verwijzingen niet opgelost voor de release van Adobe Experience Manager Guides van december 2023.
* HULPLIJNEN-13486: **dossiers van de Filter van de 1} basislijn werken niet met de Naam van het Dossier in de Redacteur van het Web.**
