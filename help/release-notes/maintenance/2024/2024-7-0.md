---
title: Nota's van de Versie van het onderhoud van  [!DNL Adobe Experience Manager]  as a Cloud Service verbonden aan 2024.7.0 eigenschapactivering.
description: Nota's van de Versie van het onderhoud van  [!DNL Adobe Experience Manager]  as a Cloud Service verbonden aan 2024.7.0 eigenschapactivering.
...
In het volgende gedeelte worden de opmerkingen bij de technische release voor de onderhoudsreleases van Experience Manager as a Cloud Service beschreven die zijn gekoppeld aan activering van de functie 2024.7.0.
...
De activering van de 2024.7.0-functie biedt de volledige functie die is ingesteld voor deze onderhoudrelease. Zie [&#x200B; Experience Manager geeft Roadmap &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap) voor meer informatie vrij.
...
* SITES-21491: [ Open API ] het eindpunt van CF PATCH zou levende verhoudingen op gebiedsniveau moeten respecteren.
* SITES-21434: [ Open API ] het eindpunt van CF GET zou levende verhoudingen op gebiedsniveau moeten respecteren.
...
* CQ-4353931: [ Vertaling ] voegt jcr :uuid in vertaalbronpagina/xf/activa toe wanneer het mist.
* CQ-4357591: [ Vertaling ] wijzig &quot;Associate JCR :UUID&quot;werkschema om voor Pagina&#39;s/XF te werken.
...
* SITES-22343: &lbrace;de Fragmenten van de Inhoud [ Semantische type &quot;opsomming&quot;wordt gebroken.]
...
* SITES-21887: [ Open API ] Ongeldige ETag die door POST variatieeindpunt is teruggekeerd.
