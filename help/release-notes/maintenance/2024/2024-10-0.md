...
U zou overgang aan [ het Gebruik API van Java moeten, ](https://experienceleague.adobe.com/en/docs/experience-manager-htl/content/java-use-api) dat betere prestaties, gemakkelijker het zuiveren, en grotere steun op lange termijn aanbiedt.
