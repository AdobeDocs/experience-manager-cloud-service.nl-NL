---
title: Nota's van de Versie van het onderhoud van  [!DNL Adobe Experience Manager]  as a Cloud Service verbonden aan 2024.9.0 eigenschapactivering.
description: Nota's van de Versie van het onderhoud van  [!DNL Adobe Experience Manager]  as a Cloud Service verbonden aan 2024.9.0 eigenschapactivering.
...
In het volgende gedeelte worden de opmerkingen bij de technische release voor de onderhoudsreleases van Experience Manager as a Cloud Service beschreven die zijn gekoppeld aan activering van de functie 2024.9.0.
...
De activering van de 2024.9.0-functie biedt de volledige functie die is ingesteld voor deze onderhoudrelease. Zie [ Experience Manager geeft Roadmap ](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap) voor meer informatie vrij.
...
| AEM-kerncomponenten | 2.26.0. | [ AEM WCM de Componenten van de Kern ](https://github.com/adobe/aem-core-wcm-components) |
...
* CQ-4358270: AEM Translation Kit: augustus 2008.
...
* SKYOPS-81179: AEM bouwt tests voor bundeltogging.
...
* CMGR-60225: uitvoeringsfout via een pijplijn vastgesteld bij AEM Sites CS-klant tijdens validatie van update naar AEM versie 17486.
