...
### Medewerkers in AEM (Beta-programma) {#agents-in-aem-beta-program}
...
Dit programma duurt doorgaans 4 tot 6 weken, maar kan op maat worden gemaakt om flexibel te zijn met betrekking tot uw mogelijkheden om actief deel te nemen.
...
* [&#x200B; Verbeteringen aan de Placeholder van het Voetnoot in Aanpassings Forms (de Componenten van de Stichting) &#x200B;](/help/forms/footnotes-richtextsupport.md):
   * De rendering van voetnoten is verder verfijnd ter ondersteuning van opmaak met meerdere regels door regeleinden, waardoor de presentatie van voetnootinhoud duidelijker en uitdrukkelijker wordt.
...
* [&#x200B; wint waarden van een serie JSON &#x200B;](/help/forms/invoke-service-enhancements-rule-editor.md#retrieve-property-values-from-a-json-array) terug: De uitgebreide mogelijkheden van de gegevensintegratie laten nu APIs toe om door douanefuncties worden aangehaald om waarden uit series efficiënt te halen JSON en hen direct te binden aan de Adaptieve gebieden van de Vorm. Deze verbetering stroomlijnt gegevensverbruik, minimaliseert handmatige mapping, en steunt dynamischere, gegeven-gedreven vormervaringen.

* **Roep Geassocieerde UI op een Publish instantie** aan: De uitgebreide steun is nu beschikbaar om Associate UI op te halen direct op Publish instanties. Dit vermogen bepaalt de vereiste configuratie, de loonlaststructuur, en aanroepingsstroom, die integratie vereenvoudigen en plaatsing over milieu&#39;s versnellen.
