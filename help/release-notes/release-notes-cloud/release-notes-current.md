...
De releasedatum van [!DNL Adobe Experience Manager] als een [!DNL Cloud Service] huidige release met functies (2026.1.0) is 29 januari 2026. De volgende release met functies (2026.2.0) is gepland voor 3 maart 2026.
...
Adobe Experience Manager (AEM) bètaprogramma&#39;s zijn een manier waarop klanten toegang krijgen tot pre-releasefuncties en -code, feedback kunnen geven en de toekomst van AEM kunnen begeleiden.
...
**Voordelen van het deelnemen**
Door vroege toegang te krijgen tot functies die Adobe ontwikkelt, kunnen klanten en partners feedback geven en de productontwikkeling vorm geven. Het helpt hen ook om zich voor te bereiden om nieuwe mogelijkheden vóór algemene beschikbaarheid aan te nemen.

**Huidige bètaprogramma&#39;s**
In de volgende secties worden actieve bètaprogramma&#39;s weergegeven.
...
### Cloud Manager (Beta-programma&#39;s) {#cloud-manager-beta-programs}
...
De Dienst van de Wolk AEM omvat nu {de Servers MCP van 0} Inhoud **, die een gestandaardiseerde manier voor AI-Aangedreven ervaringen verstrekken om met de inhoud van AEM door MCP-compatibele hulpmiddelen te werken.**

Ontwikkelaars en veeleisende gebruikers die werken in chatapps en agentplatforms, kunnen AEM verbinden met aangepaste kopieerapparaten en automatiseringen, zodat het werken met content onderdeel wordt van end-to-end bedrijfsworkflows.

AEM biedt twee servers:

1. **read-only Server van de Inhoud MCP** - voor het terugwinnen van inhoud veilig
1. **las/schrijf de Server van Inhoud MCP** - voor het aanbrengen van veranderingen in inhoud

Deze servers MCP omvatten hulpmiddelen om met **Pagina&#39;s** te werken, **de Fragmenten van de Inhoud**, en **Assets**, en kunnen van de volgende cliënten worden gebruikt MCP: **ChatGPT**, **Claude**, **Cursor**, en **de Studio van Microsoft Copilot**.
...
**Verbeteringen aan de Placeholder van het Voetnoot in Aangepaste Forms (de Componenten van de Stichting)**

* Toegevoegde [&#x200B; multi-line steun met lijnonderbrekingen &#x200B;](/help/forms/footnotes-richtextsupport.md), toelatend duidelijkere en uitdrukkelijker presentatie van voetnootinhoud.
* Voetnoten blijven nu blijvend zichtbaar binnen de plaatsaanduiding voor voetnoten, ongeacht de zichtbaarheid van de desbetreffende deelvensters, zodat consistente toegang tot kritieke informatie wordt gewaarborgd.
  ![&#x200B; Beschrijving van voetnoten &#x200B;](/help/forms/assets/footnote-description.png){height=50%}

### Nieuwe functies voor vroege toegang in AEM Forms {#forms-new-early-access-features}

**wint waarden van een serie JSON** terug

De uitgebreide mogelijkheden van de douanefunctie aan [&#x200B; extractiewaarden van JSON series &#x200B;](/help/forms/invoke-service-enhancements-rule-editor.md#retrieve-property-values-from-a-json-array), die via een API vraag worden ontvangen, en binden hen direct aan de Adaptieve gebieden van de Vorm. U kunt nu bedrijfslogica en regels met minimale handmatige gegevenstoewijzing ontwikkelen.

**stel Associate UI op een Publish instantie in werking**

U kunt [&#x200B; associate UI &#x200B;](/help/forms/interactive-communication/associate-ui-in-interactive-communication-editor.md) nu in werking stellen direct op Publish instanties. Dit staat uw agenten toe om tot Associate UI toegang te hebben en gemakkelijk mededelingen voor uw klanten te personaliseren.
...
De vervangen API&#39;s die 2/26/2026 verwijderen, mogen niet langer in de code worden gebruikt. Om implementatieblokken te voorkomen, verwijdert u het API-gebruik vóór 30 maart 2026. Belangrijke datums:
...
* **Maart 30, 2026**: De pijpleidingen van Cloud Manager die code bevatten die deze APIs gebruiken zullen **&#x200B;**&#x200B;tijdens de **Kwaliteit van de Code** stap ontbreken, **blokkerend plaatsingen** van nieuwe code tot het gebruik wordt verwijderd.
* **Mei 4, 2026**: De milieu&#39;s die nog deze APIs gebruiken kunnen **niet meer kritieke de versiepeupdates van Adobe ontvangen**.
...
### [!DNL Experience Manager] als een [!DNL Cloud Service] Foundation Early adopter-functie {#foundation-early-adopter}
