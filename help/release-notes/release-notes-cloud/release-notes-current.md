...
# Opmerkingen bij de huidige release voor [!DNL Adobe Experience Manager] as a Cloud Service {#release-notes}
...
## AEM bètaprogramma&#39;s {#aem-beta-programs}
...
Om binnen te kiezen om aan dit programma deel te nemen, e-mail [&#x200B; aemagentsteam@adobe.com &#x200B;](mailto:aemagentsteam@adobe.com) en omvat de volgende details voor zover mogelijk:
    ...
    * Geef een lijst op met specifieke agents die u of uw team wilt gebruiken. Of zeg eenvoudig &quot;Alle Agenten.&quot;

### AEM Foundation (Beta-programma&#39;s)

     zie [de bètaprogramma&#39;s van de Stichting van AEM] (#foundation-vroege-adopter).

### Cloud Manager (Beta-programma&#39;s)

     zie [de bètaprogramma&#39;s van Cloud Manager] (/help/implementing/cloud-manager/release-notes/current.md).
...
Adobe bevorderde **het Stadium** en **de milieu&#39;s van de Productie** aan hoog-prestaties **Java 21 runtime** op 14 oktober, 2025. Beginnend **eind Januari**, noch zal de SDK van de Dienst van de Wolk AEM noch om het even welke wolkenmilieu&#39;s met runtime van Java 11 werken.
