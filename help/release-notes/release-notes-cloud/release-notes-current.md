...
AEM biedt een aantal zakelijke agents waarmee u uw content kunt versnellen en wijzigingen automatisch kunt ordenen. Voor meer informatie, zie [&#x200B; het Overzicht van BedrijfsAgenten van AEM &#x200B;](/help/ai-in-aem/agents/overview.md).
...
Beginnend op **10th van 10 december &lbrace;, zullen om het even welke niet gestaafde overrides van het douaneregistreren worden genegeerd.** Op basis van onze analyse zullen de meeste klanten niet worden beïnvloed en heeft Adobe contact opgenomen met klanten van wie de huidige configuratie mogelijk wordt beïnvloed.
