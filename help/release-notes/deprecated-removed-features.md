...
>[!IMPORTANT]
>
>Verscheidene [ afgekeurde APIs ](#aem-apis) zal op **4 Mei, 2026** worden verwijderd. Wijzig deze belangrijkste datums en effecten:
>
...
>* **Mei 4, 2026**: De milieu&#39;s die nog vervangen APIs gebruiken **zullen geen kritieke de versiedrupdates van Adobe ontvangen** en zijn niet onderworpen aan de standaardverplichtingen van Adobe rond prestaties en beschikbaarheid. Dit heeft tot gevolg dat u geen nieuwe functies of oplossingen voor problemen krijgt, dat de stabiliteit van de toepassing en de uptime negatief worden beïnvloed en dat de blootstelling aan beveiligingsrisico&#39;s verder toeneemt.
>
>Om implementatieblokken te voorkomen, verwijdert u het API-gebruik vóór 30 maart 2026.
...
<td>org.apache.felix.webconsole<br>org.apache.felix.webconsole.bundleinfo<br>org.apache.felix.webconsole.i18n<br>org.apache.felix.webconsole.spi</td>
  ...
  <tr>
    ...
    <td>Deze API is vervangen.</td>
    <td>10-07-2024</td>
    <td>30-09-2026</td>
  </tr>
  <tr>
    <td>com.day.cq.mailer.commons</td>
    <td>Deze API is afgekeurd omdat deze afhankelijk is van een komma-lang (die sinds 2021 afgekeurd is).</td>
    <td>30-11-2025</td>
    <td>30-09-2026</td>
  </tr>
  <tr>
    <td>com.adobe.granite.httpcache.api</td>
    <td>Deze API wordt niet meer ondersteund.</td>
    <td>01-01-2026</td>
    <td>30-09-2026</td>
  </tr>
  <tr>
...
<td>org.apache.commons.lang<br>org.apache.commons.lang.enums<br>org.apache.commons.lang.builder<br>org.apache.commons.lang.exception<br>org.apache.commons.lang.math<br>org.apache.commons.lang.mutable<br>org.apache.commons.lang.reflect<br>org.apache.commons.lang.text<br>org.apache.commons.lang.time</td>
  ...
  <tr>
    ...
    <td>De OSGi Service HTTP API is verouderd, te gebruiken gelieve OSGi Servlet Whiteboard in plaats daarvan.</td>
    <td>01-05-2024</td>
    <td>31-12-2027 (voorlopig)</td>
  </tr>
  </tbody>
...
Als u besluit om uw eigen versie van de Vervangen API te implementeren, bijvoorbeeld uw eigen versie van Guava, moet u ervoor zorgen dat al uw bundels die deze API gebruiken, zijn aangesloten op uw versie. Als u besluit om dezelfde hoofdversie te implementeren als die momenteel in Cloud Service is opgenomen, hoeft u verder niets te doen. Nochtans, als u de aanbevelingen volgt en de recentste versie opstelt dan moet u uw Maven project aanpassen, die bibliotheek als nieuwe gebiedsdeel vóór `aem-sdk-api` omvatten. Op deze manier wordt uw code naar de nieuwe versie getelegrafeerd. Zodra u de veranderingen hebt aangebracht, verifieer met [ AEM as a Cloud Service SDK bouwt Analysator Gemaakte Insteekmodule ](https://experienceleague.adobe.com/en/docs/experience-manager-core-components/using/developing/archetype/build-analyzer-maven-plugin) dat het gebruik van Vervangen API niet meer wordt gemarkeerd.
...
* Als u ACS AEM Commons gebruikt, werk dan aan recentste versie (minstens 6.11.0) bij en zorg ervoor dat om `cloud` te gebruiken classificfier.
...
* Als u ACS AEM Commons gebruikt, werk dan aan recentste versie (minstens 6.11.0) bij en zorg ervoor dat om `cloud` te gebruiken classificfier.
* Als u `io.wcm:io.wcm.caconfig.extensions` gebruikt, moet u deze bijwerken naar ten minste versie 1.9.2
...
* Als u `com.adobe.aio.aem:aio-lib-osgi` gebruikt, moet u een update naar de meest recente versie uitvoeren (minimaal 2.0.12).
