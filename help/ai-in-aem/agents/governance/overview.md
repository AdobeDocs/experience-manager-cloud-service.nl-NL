---
title: Overzicht van de bestuursagent
...
# Overzicht van de bestuursagent {#governance-agent}

De **Agent van de Governance** is een oplossing die wordt ontworpen om merkintegriteit en naleving over Adobe Experience Manager te beschermen. Het handhaaft veiligheid, regelgevende, en merkbeleid om ervoor te zorgen dat elke interactie en activering aan gevestigde normen voldoet. De agent van de Governance is volledig geïntegreerd in AI medewerker en wordt ontworpen om binnen ondernemingsmilieu&#39;s foutloos te werken door **A2A (agent-aan-Agent)** en **MCP (ModelProtocol van de Controle)** hulpmiddelen leveraging. Dankzij deze integratie kan de agent verbinding maken met geavanceerde AI-operatoren, zoals ChatGPT, Claude en andere externe AI-systemen, zodat u over alle platforms over flexibele en schaalbare intelligentie beschikt.

De belangrijkste mogelijkheden omvatten:

* **Brand governance:** handhaaf merkconsistentie en verminder handrevisie door merkcontroles over inhoud en activa te automatiseren
* **Toestemmingen &amp; Digital Rights Management (DRM):** verzekert veilige en volgzame samenwerking door toestemmingen en gebruiksrechten over digitale activa te controleren.

Door deze functies te combineren, verkleint de Governance Agent het risico en maakt hij snelle, veilige en on-brand levering op grote schaal mogelijk.
...
* *is deze pagina gericht aan mijn merk?`https://www.website/en.html`*
* *volgt dit `https://www.website/en.html` de richtlijnen van het merkoverseinen?*
...
#### Machtigingsbeheer in Content Hub {#permission-management-in-content-hub}
...
* *toon alle bestaande Content Hub ABAC regels.*
* *creeer een regel die de &quot;Marketing&quot;groepstoegang tot alle activa geeft.*
* *geef de groep van de Verkoop toegang tot activa waar marketing :segment EMEA evenaart.*
* *Schrap alle regels die toegang tot extern-agentschap* verlenen
* *wat ABAC in Content Hub is en wat kan u me helpen doen?*
...
* *Zijn om het even welk van mijn activa die spoedig verlopen?*
* *vind me alle fietsactiva die vorige maand verliepen.*
