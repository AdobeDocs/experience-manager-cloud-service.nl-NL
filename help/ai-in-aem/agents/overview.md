...
>[!IMPORTANT]
>
>Om de agenten te gebruiken moet u in het Programma van de Ontdekkingsreiziger inschrijven. U kunt meer informatie over het Programma van de Ontdekkingsreiziger van de Ontdekkingsreiziger van AEM van Agenten [&#x200B; hier &#x200B;](/help/release-notes/release-notes-cloud/release-notes-current.md#aem-beta-programs) vinden.
