...
description: Leer hoe u de Content Optimization Agent kunt gebruiken om te transformeren hoe gebruikers elementen verfijnen en aanpassen door natuurlijke taalinstructies toe te passen om kanaalklare variaties te maken.
...
De Content Optimization Agent transformeert hoe gebruikers elementen verfijnen en aanpassen door natuurlijke taalinstructies toe te passen om kanaalklare variaties te maken. Of het produceren van nieuwe vertoningen, het aanpassen van visuele eigenschappen, het veranderen van achtergronden, of het voorbereiden van activa voor specifieke digitale kanalen, de agent interpreteert gebruikersintent en voert complexe het uitgeven taken automatisch uit. Het werkt naadloos met de Agent van de Ontdekking, die de activa neemt en geoptimaliseerde variaties produceert gebruikend kern [ Dynamische Media met mogelijkheden OpenAPI ](/help/assets/dynamic-media-open-apis-overview.md) die merk, kanaal, en campagnevereisten zonder handontwerpinspanning ontmoeten.

Tot de belangrijkste voordelen van Inhoud optimaliseren behoren:
...
* **[naadloze samenwerking met de Agent van de Ontdekking](/help/ai-in-aem/agents/discovery/overview.md)**: Bouwt op de activa voort die door de Agent van de Ontdekking worden geïdentificeerd, toelatend activa van begin tot eind terugwinning en optimalisering door natuurlijk gesprek.
...
De Content Optimization Agent biedt de volgende vaardigheden:

* **Begrijp intent door natuurlijke taal**

  De agent van de Optimalisering van de Inhoud interpreteert gebruikersintent van natuurlijke taalherinneringen, rekenschap gevend voor kanaal, campagne, en publiekscontext om de meest relevante optimaliseringsacties te bepalen.

* **produceert dynamische inhoudvarianten**

  De Content Optimization Agent maakt geoptimaliseerde varianten als dynamische URL&#39;s op maat van verschillende kanalen en opmaaktypen.

* **optimaliseert beeldinhoud**

  De Content Optimization Agent past verbeteringen toe, zoals het omzetten van indelingen, het aanpassen van de resolutie, bijsnijden en verscherpen om de afbeeldingskwaliteit te verbeteren.

* **multi-variant activa optimalisering**

  Met de Content Optimization Agent kunt u meerdere geoptimaliseerde afbeeldingsvariaties genereren op basis van de elementen die door de Discovery Agent worden geretourneerd. Hierbij wordt één natuurlijke-taalprompt gebruikt, zodat gebruikers snel en efficiënt uitvoeringen kunnen maken die geschikt zijn voor kanalen.

## Personas {#personas-content-optimization-agent}

Channel Marketers, de belangrijkste persoon voor Content Optimization Agent, kunnen de juiste broninhoud met hoge resolutie selecteren en geoptimaliseerde indelingen aanvragen die zijn afgestemd op hun kanalen en publiekssegmenten.

De regionale Marketers en de Werknemers van het Agentschap kunnen de Agent van de Optimalisering van de Inhoud ook gebruiken om kanaalklaar beeldvariaties snel te produceren die snellere, consistentere inhoudsproductie steunen.

## Hoe te om tot de Agent van de Optimalisatie van de Inhoud toegang te hebben? {#access-content-optimization-agent}

Via de AI-assistent hebt u toegang tot de agents in AEM. Meld u aan bij experience.adobe.com en u kunt interactie aangaan met AI Assistant door de vraag in de natuurlijke taal op te geven met behulp van het veld `Ask AI Assistant anything` :
...
De herinneringen van de Optimalisering van de Inhoud van het gebruik door naar de juiste activa door de [ Agent van de Ontdekking ](/help/ai-in-aem/agents/discovery/overview.md) te zoeken. Wanneer de relevante afbeeldingen zijn weergegeven, kunnen gebruikers rechtstreeks uit de zoekresultaten geoptimaliseerde of kanaalspecifieke varianten voor een of meerdere elementen genereren. Deze workflow garandeert input van hoge kwaliteit en consistent betere optimalisatieresultaten. [ zie de volledige lijst van beschikbare optimalisaties ](https://developer.adobe.com/experience-cloud/experience-manager-apis/api/stable/assets/delivery/).
...
* **de verwezenlijking van de vertoning van de hoge resolutie**
  ...
  Onderzoek naar het juiste middel gebruikend de [ agent van de Ontdekking ](/help/ai-in-aem/agents/discovery/overview.md) en gebruik dan de volgende herinneringen in het geval van veelvoudige onderzoeksresultaten:
...
Wanneer u een optimalisatieverzoek opgeeft, retourneert de Content Optimization Agent het verbeterde element samen met handige toegangsopties op basis van het type element:
...
![ de resultaten van de Optimalisering van de Inhoud ](/help/ai-in-aem/agents/content-optimization/assets/download-content-optimization.png)
...
* De Content Optimization Agent biedt momenteel geen ondersteuning voor PNG-elementen.
