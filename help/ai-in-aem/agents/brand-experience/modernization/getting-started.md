...
Leer de eerste stappen om aan de slag te gaan gebruikend de Agent van de Modernisering van de Ervaring en de Console van de Modernisering van de Ervaring.

>[!NOTE]
>
>Als u geïnteresseerd bent in het gebruik van de Experience Modernization Console, kunt u via uw accountmanager om toegang vragen voor een vlotte instapervaring.

## Een Edge Delivery GitHub-opslagplaats voorbereiden {#prepare-repo}

>[!NOTE]
>
>Een AEM Sites- en Universal Editor-project gebruiken? Volg [&#x200B; Begonnen het Worden voor AEM Sites/Universele de opstellingsstappen van de Redacteur &#x200B;](/help/ai-in-aem/agents/brand-experience/modernization/getting-started-aem-authoring.md).
...
>[!TIP]
>
>[&#x200B; Controle uit de het veroorzaken gids &#x200B;](/help/ai-in-aem/agents/brand-experience/modernization/prompting-guide.md) voor meer ideeën over hoe te om de agent te veroorzaken en wat zijn vaardigheden kunnen doen.

## Inhoud uploaden {#upload-content}

>[!TIP]
>
>Als u werkt aan een AEM Sites- en Universal Editor-project, werkt het uploaden van inhoud naar AEM iets anders. Verwijs naar [&#x200B; Begonnen Worden met de Agent van de Modernisering van de Ervaring voor de Projecten van de Redacteur AEM Sites/Universal &#x200B;](/help/ai-in-aem/agents/brand-experience/modernization/getting-started-aem-authoring.md#upload-content) voor specifieke upload instructies.
...
* [&#x200B; Console van de Modernisering van de Ervaring &#x200B;](/help/ai-in-aem/agents/brand-experience/modernization/console.md) - Details op de console, zijn meningen, opties, en mogelijkheden
* [&#x200B; het Vragen Gids voor de Agent van de Modernisering van de Ervaring &#x200B;](/help/ai-in-aem/agents/brand-experience/modernization/prompting-guide.md) - Ideeën op hoe te om de agent te veroorzaken en wat zijn vaardigheden kunnen doen
