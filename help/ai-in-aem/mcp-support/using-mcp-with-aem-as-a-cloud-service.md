...
Het vormen MCP voor AEM omvat drie belangrijke delen:

1. **een eenmalige configuratie in AEM door een beheerder**, die specifieke MCP cliënttoepassingen toestaat om tot AEM toegang te hebben MCP servers
