---
title: Eigenschappen van Asset Selector voor aanpassing
...
| *filterForm Props* | Object | Nee | | Geef de filtereigenschappen op die u nodig hebt om de zoekopdracht te verfijnen. Voor! Voorbeeld: MIME-type JPG, PNG, GIF. |
...
| *onDrop* | Functie | Nee | | De functie Bij neerzetten wordt gebruikt om een middel te slepen en op een aangewezen dalingsgebied vrij te geven. Het maakt interactieve gebruikersinterfaces mogelijk waarin elementen naadloos kunnen worden verplaatst en verwerkt. |
...
| *onUploadStart* | Functie | Nee |  | Dit is een callback-functie die wordt gebruikt om de uploadbron door te geven tussen Dropbox, OneDrive of local. De syntaxis is `(uploadInfo: UploadInfo) => void` |
