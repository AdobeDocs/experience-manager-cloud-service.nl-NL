...
U kunt een nieuwe configuratie maken op de Adobe I/O om AEM Assets met Brand Portal te configureren.
...
* [Elementen publiceren van AEM Assets naar Brand Portal](publish-to-brand-portal.md#publish-assets-to-bp)
...
De distributie bevat de volgende logboeken:
...
* DSTRK3 (verzoek 3): Het systeem brengt een ander verzoek in werking om de omslag te publiceren waarin de activa bestaan en herhaalt de omslag in het Portaal van het Merk.
...
* queue-bpdistributionagent0 (DSTRQ3): Het systeem repliceert de omslag die de activa in het Portaal van het Merk bevat.
