...
De beheerders kunnen nieuwe meta-gegevensgebieden voor activa toevoegen uploadt door **te klikken voegt meta-gegevens** in het **3} lusje van de Invoer toe, die het specificeren aan het aangewezen bezit van het meta-gegevensschema in kaart brengen, het inputtype selecteren, en het beslissen als het gebied wordt vereist of facultatief.** Na bevestiging en het bewaren, wordt het nieuwe gebied beschikbaar voor gebruikers tijdens activa uploadt.
