...
1. Open [!DNL Experience Manager] > **[!UICONTROL Tools]** > **[!UICONTROL Cloud Services]** in **[!UICONTROL Workfront Tools Configuration]** , selecteer de configuratie en selecteer **[!UICONTROL Properties]** .
