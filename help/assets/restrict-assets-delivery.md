...
1. Klik op het veld dat u zojuist hebt toegevoegd en voer de volgende updates uit in het deelvenster **[!UICONTROL Settings]** :
   ...
   1. Werk **[!UICONTROL Map to property]** aan _bij./jcr :content/onTime_ voor **Op tijd** gebied en _./jcr :content/offTime_ voor **Van tijd** gebied.
...
1. Werk **[!UICONTROL Metadata property]** aan _bij./jcr :content/onTime_ voor **Op tijd** gebied en _./jcr :content/offTime_ voor **Van tijd** gebied.
1. Klik op **[!UICONTROL Save]**.
