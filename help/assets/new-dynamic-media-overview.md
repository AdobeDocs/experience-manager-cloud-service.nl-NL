...
* **de consistentie van het Merk**: Slechts [ merk-goedgekeurde activa ](/help/assets/approved-assets.md) worden blootgesteld aan stroomafwaartse toepassingen. [ de Managers en de Marketers van de Merk handhaven strikte controle over merkactiva ](/help/assets/restrict-assets-delivery.md). Alleen goedgekeurde en nieuwste versie van het middel is beschikbaar voor gebruik, zodat alle kanalen en toepassingen consistent blijven.
...
* **Dynamische activa transformatie**: Ons systeem staat voor de transformatie van het beeld toe het gebruiken van parameters URL die als beeldbepalingen worden bekend. [ bijvoorbeeld, breedte, hoogte, roteert, keert, kwaliteit, gewas, en formaat ](/help/assets/deliver-assets-apis.md) om. Dynamic Media met OpenAPI-mogelijkheden ondersteunt ook mogelijkheden voor slim uitsnijden van afbeeldingen. Transformeerde uitvoeringen worden dynamisch gegenereerd en naadloos via de CDN geleverd.
...
* **Inzichten van Gegevens om geïnformeerde besluiten** te nemen: Buiten activabeheer en levering, vangt het de inzichten van leveringsgegevens in activa leveranties bij CDN die de managers van het Merk toestaan om leveringsmetriek over kanalen te volgen. Het stelt hen in staat gegevensgestuurde beslissingen te nemen met het oog op een continue optimalisering van het beheer en de leveringsstrategieën van activa.

![ Nieuw de gegevensstroomdiagram van Dynamic Media ](assets/dm-openapi-dfd.png)
