...
* ![ Kopieer het pictogram van 0} exemplaar het geselecteerde dossier of de omslag.](assets/do-not-localize/copy-icon.png)

* ![ Beweeg het pictogram van de beweging 0} {het geselecteerde activa of de omslag naar een verschillende plaats in de bewaarplaatshiërarchie.](assets/do-not-localize/move-icon.png)
