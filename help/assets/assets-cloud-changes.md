...
| Homepage | Niet ondersteund | Zie {de ervaring van de Pagina van 0} Huis in [[!DNL Assets]  6.5  [!DNL Experience Manager] &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-manager-65/content/assets/using/assets-home-page) |
| Elementen extraheren uit ZIP-archief | Niet ondersteund | Zie {de extractie van 0} ZIP in [&#x200B; 6.5  [!DNL Experience Manager] .](https://experienceleague.adobe.com/nl/docs/experience-manager-65/content/assets/managing/manage-assets#extractzip) |
