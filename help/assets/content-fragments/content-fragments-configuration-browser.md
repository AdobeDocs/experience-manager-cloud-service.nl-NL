...
Leer hoe u bepaalde functionaliteit voor inhoudsfragmenten in de configuratiegrowser kunt inschakelen voor het gebruik van AEM-functies voor krachtige koploze levering.
...
Als u andere configuraties (behalve algemene configuraties) wilt gebruiken in een vergelijkbare Assets-map, moet u de verbinding definiëren. Deze verbinding wordt gedaan door de aangewezen **Configuratie** in het **lusje van de Diensten van de Wolk** van de **Eigenschappen van de Omslag** van de aangewezen omslag te selecteren.
