...
description: Leer hoe u eenvoudig een JSON-weergave van uw inhoudsfragmenten kunt bekijken bij het implementeren van uw AEM-oplossing zonder kop.
...
Wanneer u modellen voor inhoudsfragmenten ontwikkelt als onderdeel van uw AEM-implementatie zonder kop, kunt u voorbeeld-JSON-uitvoer voor een inhoudsfragment weergeven, zoals is gebaseerd op een model. Als u bijvoorbeeld wilt weten hoe de uiteindelijke uitvoer eruit zal zien. Dit kan handig zijn voor het valideren van de JSON-modelstructuur, bijvoorbeeld met standaardvoorbeeldinhoud per gegevenstype.
