...
1. Klik in de gebruikersinterface van de Experience Manager op **[!UICONTROL Assets]** > **[!UICONTROL Files]**.
...
>* [Elementen downloaden via de Adobe Assets Link vanuit de ondersteunde Adobe Creative Cloud-apps](https://helpx.adobe.com/nl/enterprise/using/manage-assets-using-adobe-asset-link.html)
