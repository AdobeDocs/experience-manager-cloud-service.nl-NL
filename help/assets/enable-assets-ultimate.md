...
1. [&#x200B; creeer een nieuw programma &#x200B;](/help/journey-onboarding/create-program.md) en [&#x200B; voeg milieu&#39;s &#x200B;](/help/journey-onboarding//create-environments.md) aan het toe.
   ...
   Selecteer **[!UICONTROL Solutions & Add-ons]** op het tabblad **[!UICONTROL Assets Ultimate]** tijdens het maken van het nieuwe programma. U kunt **[!UICONTROL Assets Ultimate]** ook uitbreiden en selecteren **[!UICONTROL Content Hub]** om [&#x200B; Content Hub &#x200B;](/help/assets/product-overview.md) voor activadistributie toe te laten.
