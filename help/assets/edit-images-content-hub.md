...
Gebruikers met toegangsrechten tot Adobe Express en AEM Assets Content Hub, en die het recht hebben om elementen opnieuw te mixen aan nieuwe variaties, kunnen afbeeldingen bewerken met Content Hub.

### Hoe kan ik een afbeelding bewerken met Adobe Express in AEM Assets Content Hub?

Om een beeld uit te geven, klik **Open in Adobe Express** op de activakaart van het beeld of open de details van het beeld en klik het embleem van Adobe Express. Hiermee wordt de ingesloten Adobe Express-editor in AEM Assets Content Hub geladen, zodat u uw bewerkingen kunt uitvoeren zonder het platform te verlaten.

### Welke bewerkingsfuncties biedt Adobe Express in AEM Assets Content Hub?

Adobe Express biedt diverse functies voor het bewerken van afbeeldingen, zoals het vergroten of verkleinen van afbeeldingen, het verwijderen of wijzigen van de achtergrondkleur, het uitsnijden van afbeeldingen en het combineren van afbeeldingen met door AI gegenereerde afbeeldingen of tekst.

### Welke bestandsindelingen kan ik mijn bewerkte afbeeldingen opslaan zoals in AEM Assets Content Hub?

U kunt de bewerkte afbeeldingen opslaan in de indelingen .png (goede kwaliteit), .JPG (geschikt voor kleine bestanden) of .PDF (geschikt voor documenten).

### Welke velden moet ik invullen wanneer ik een bewerkte afbeelding opslaat in Content Hub?

Wanneer het opslaan van een uitgegeven beeld, zou u een naam voor het activa op **moeten specificeren sparen als** gebied en een campagnenaam op het **naam van de Campagne** gebied. Adobe raadt ook aan waarden op te geven in aanvullende velden, zoals Trefwoorden, Kanalen, Tijdlijn en Regio, om de zoekbaarheid en organisatie te verbeteren.

### Kan ik mijn bewerkingen opslaan als een nieuw middel in Content Hub?

Ja, na het uitgeven, kunt u **sparen als nieuwe activa** klikken om uw veranderingen als nieuw activa in Content Hub te bewaren.
