...
## Veelgestelde vragen {#faqs-edit-images-content-hub}

### Wie kan afbeeldingen bewerken in AEM Assets Content Hub?

Gebruikers met toegangsrechten tot Adobe Express en AEM Assets Content Hub en die het recht hebben om elementen opnieuw te mixen naar nieuwe variaties, kunnen afbeeldingen bewerken met AEM Assets Content Hub.

### Hoe kan ik een afbeelding bewerken met Adobe Express in AEM Assets Content Hub?

Om een beeld in AEM Assets Content Hub uit te geven, klik **Open in Adobe Express** op de activakaart van het beeld of open de details van het beeld en klik het embleem van Adobe Express. Hiermee wordt de ingesloten Adobe Express-editor in AEM Assets Content Hub geladen, zodat u uw bewerkingen kunt uitvoeren zonder het platform te verlaten.

### Welke bewerkingsfuncties biedt Adobe Express in AEM Assets Content Hub?

Adobe Express biedt verschillende functies voor het bewerken van afbeeldingen in AEM Assets Content Hub, zoals het vergroten of verkleinen van afbeeldingen, het verwijderen of wijzigen van achtergrondkleuren, het uitsnijden van afbeeldingen en het combineren van afbeeldingen en tekst met door AI gegenereerde afbeeldingen of tekst.

### Welke bestandsindelingen kan ik mijn bewerkte afbeeldingen opslaan zoals in AEM Assets Content Hub?

U kunt de bewerkte afbeeldingen opslaan in de indelingen PNG (goede kwaliteit), JPG (geschikt voor kleine bestanden) of PDF (geschikt voor documenten) in AEM Assets Content Hub.

### Welke velden moet ik invullen wanneer ik een bewerkte afbeelding opslaat in AEM Assets Content Hub?

Wanneer het opslaan van een uitgegeven beeld in AEM Assets Content Hub, zou u een naam voor het element op **moeten specificeren sparen als** gebied en een campagnenaam op het **naam van de Campagne** gebied. Adobe raadt ook aan waarden op te geven in aanvullende velden, zoals Trefwoorden, Kanalen, Tijdlijn en Regio, om de zoekbaarheid en organisatie te verbeteren.

### Kan ik mijn bewerkingen opslaan als een nieuw middel in AEM Assets Content Hub?

Ja, na het uitgeven, kunt u **sparen als nieuwe activa** klikken om uw veranderingen als nieuw activa in AEM Assets Content Hub te bewaren.

### Kunnen beheerders de velden aanpassen terwijl ze elementen uploaden naar AEM Assets Content Hub?

Ja, beheerders kunnen configureren welke velden verplicht of optioneel zijn bij het toevoegen van elementen aan AEM Assets Content Hub, zoals Campagnenaam, Trefwoorden en Kanalen, op basis van de organisatorische behoeften. Gebruik het **lusje van de Invoer** op de Configuratie UI om de gebieden te vormen.
