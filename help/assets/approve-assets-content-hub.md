...
Ja, activa kunnen bulksgewijs worden goedgekeurd. In de mening van Assets, selecteer veelvoudige activa, klik **BulkMeta-gegevens uitgeven**, uitgezocht **Goedgekeurd** in het **5&rbrace; gebied van de Status &lbrace;onder Eigenschappen, en klik** sparen **.** Alle geselecteerde middelen zijn beschikbaar in AEM Assets Content Hub.
