...
1. Selecteer **[!UICONTROL Google Cloud]** op de pagina **[!UICONTROL Console]** in de rechterbovenhoek.
...
1. Selecteer **[!UICONTROL Select a project]** in het dialoogvenster **[!UICONTROL New Project]** .
...
1. Voer een van de volgende handelingen uit:
   ...
   * Selecteer **[!UICONTROL Getting Started]** op het dashboard van uw project in de **[!UICONTROL Explore and enable APIs]** -kaart.
   * Selecteer **[!UICONTROL APIs]** op het dashboard van uw project in de **[!UICONTROL Go to APIs overview]** -kaart.

1. Selecteer **[!UICONTROL APIs & Services]** in het midden boven aan de pagina **[!UICONTROL ENABLE APIS AND SERVICES]** . <!-- NEXT STEP BELOW IS STEP 10 -->
...
1. Selecteer **[!UICONTROL Credentials]** boven op de pagina **[!UICONTROL CREATE CREDENTIALS]** en selecteer vervolgens **[!UICONTROL OAuth client ID]** .
...
1. Selecteer **[!UICONTROL OAuth client created]** in het dialoogvenster **[!UICONTROL OK]** .
