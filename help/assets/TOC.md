...
+  Dynamic Media {#dynamicmedia}
   ...
   + [Optioneel - Dynamic Media configureren, algemene instellingen](dynamic-media/dm-general-settings.md)
   + [Optioneel - Dynamic Media configureren, installatie voor publiceren](dynamic-media/dm-publish-settings.md)
