...
1. Meld u aan bij AEM Assets als fiatteur en navigeer naar de interface Middelen. Als u elementen wilt goedkeuren, klikt of tikt u op het **[!UICONTROL Notifications]** pictogram en selecteert u de revisietaak in de lijst.
...
1. Tik of klik op het pictogram **[!UICONTROL Complete]** op de werkbalk. Voer in het dialoogvenster een opmerking in en tik/klik om te bevestigen. **[!UICONTROL Complete]**
...
1. Tik of klik op **[!UICONTROL Submit]** en tik of klik vervolgens op **[!UICONTROL Done]** om het bevestigingsbericht te sluiten. Er wordt een bericht voor de nieuwe taak naar de goedkeurder verzonden.
1. Meld u aan bij AEM Assets als fiatteur en navigeer naar de middelenconsole. Tik op het **[!UICONTROL Notifications]** pictogram of klik op het pictogram om elementen goed te keuren en selecteer vervolgens de revisietaak in de lijst.
1. Controleer op de pagina **[!UICONTROL Review Task]** de details van de revisietaak en tik of klik vervolgens op **[!UICONTROL Review]**.
1. Alle elementen in de verzameling zijn zichtbaar op de overzichtspagina. Select the assets and tap/click the **[!UICONTROL Approve/Reject]** icon to approve or reject assets, as appropriate.
