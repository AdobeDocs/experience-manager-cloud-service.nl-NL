...
1. Kopieer onder **[!UICONTROL Dynamic Media Cloud Settings]** op de pagina **[!UICONTROL Video Service URL]** het volledige URL-pad naar beneden. U hebt het gekopieerde pad naar de URL later nodig in de stappen.
