...
* De gebruiker activeert een gebruikersinterface-element op de website. Als u bijvoorbeeld een **[!UICONTROL Quickview]**-knop selecteert.
...
* Om alle uitgaande HTTP- verzoeken in Google Chrome te zien, druk F12 (Vensters®) of Command-Option-I (MAC) om het het hulpmiddelpaneel van de Ontwikkelaar te openen. Selecteer het tabblad Netwerk.
...
1. Selecteer **[!UICONTROL Tap to open Asset Selector]** op de pagina Carousel Banner Editor om de afbeelding voor de eerste dia te selecteren.
   ...
   * Selecteer **[!UICONTROL Tap to open Asset Selector]** in het midden van de pagina.
   ...
   Met de Kiezer van Activa, kunt u naar activa zoeken door in een sleutelwoord te typen en **[!UICONTROL Return]** te selecteren. U kunt ook filters toepassen om de zoekresultaten te verfijnen. U kunt filteren op pad, verzameling, bestandstype en tag. Selecteer het filter en selecteer vervolgens het pictogram **[!UICONTROL Filter]** op de werkbalk. Wijzig de weergave door het pictogram Weergave te selecteren en **[!UICONTROL Column View]**, **[!UICONTROL Card View]** of **[!UICONTROL List View]** te selecteren.
...
1. (Optioneel) Voer een van de volgende handelingen uit:
   ...
   * Als u een afbeelding wilt verwijderen, selecteert u de afbeelding en selecteert u **[!UICONTROL Delete Slide]** in de werkbalk.
   ...
   * Als u een voorinstelling wilt toepassen, selecteert u in de rechterbovenhoek van de pagina de vervolgkeuzelijst met voorinstellingen en selecteert u vervolgens een voorinstelling die u tegelijkertijd op de set wilt toepassen.
   Als u een dia wilt verwijderen, selecteert u de dia. Selecteer **[!UICONTROL Delete Slide]** op de werkbalk op de werkbalk. Als u een dia wilt verplaatsen, selecteert u het pictogram voor herschikking en gaat u naar de gewenste locatie.
...
1. U kunt het visuele ontwerp en het gedrag van carrouselsets wijzigen. Selecteer de tabbladen **[!UICONTROL Behavior]** en **[!UICONTROL Appearance]** als u wilt aanpassen hoe de carrouselbanner wordt weergegeven of hoe specifieke componenten zich gedragen. Zie [Voorinstellingen voor viewers beheren](/help/assets/dynamic-media/viewer-presets.md) voor meer informatie over het gebruik van de viewer-editor.
   ...
   U kunt ook een voorvertoning van de vormgeving van de carrouselbanner weergeven. Zie [(Optioneel) Voorvertoning carrouselbanners](#optional-previewing-carousel-banners).
...
Zie [(Optioneel) Voorvertoning carrouselbanners](#optional-previewing-carousel-banners).
...
1. Voer een van de volgende handelingen uit:
   ...
   * Voor afbeeldingen met hyperlinks: Sleep in de afbeelding van linksboven naar rechtsonder om het gebied met de afbeelding met hyperlinks te maken. U kunt de grootte van de afbeelding met hyperlinks aanpassen door de hoeken te slepen.
   ...
   Als u een hotspot of afbeelding met hyperlinks wilt verwijderen, selecteert u het tabblad **[!UICONTROL Actions]**. Selecteer onder de kop **[!UICONTROL Maps & Hotspots]** in de vervolgkeuzelijst **[!UICONTROL Selected Type]** de naam van de hotspot of de afbeelding met hyperlinks die u wilt verwijderen. Selecteer **[!UICONTROL Trash]** pictogram naast het menu, dan uitgezocht **[!UICONTROL Delete]**.
...
1. Voer op het tabblad **[!UICONTROL Actions]** een van de volgende handelingen uit:
   ...
   * Selecteer **[!UICONTROL Quickview]**.
      ...
      * Als u een klant van de Plaatsen van de Experience Manager <!-- and Ecommerce--> bent, selecteer het pictogram van de Plukker van het Product (vergrootglas) om de Uitgezochte pagina van het Product te openen. Als u wilt terugkeren naar de Carousel Banner Editor, selecteert u het product dat u wilt gebruiken en selecteert u vervolgens het vinkje in de rechterbovenhoek van de pagina.
   ...
   * Selecteer **[!UICONTROL Experience Fragment]**.
      ...
      * Als u een klant van de Plaatsen van de Experience Manager bent, selecteer het pictogram van het Onderzoek (vergrootglas) om de pagina van het Fragment van de Ervaring te openen. Als u wilt terugkeren naar de pagina Hotspot-beheer, selecteert u het gewenste ervaringsfragment en selecteert u **[!UICONTROL Select]** in de rechterbovenhoek van de pagina.
...
1. Voer een van de volgende handelingen uit om de Carousel-set te bewerken:
   ...
   * Als u een dia wilt toevoegen, selecteert u het pictogram **[!UICONTROL Add Slide]**. Navigeer naar het element dat u aan die dia wilt toevoegen en selecteer vervolgens het vinkje.
   ...
   * Als u een hotspot of afbeelding met hyperlinks wilt toevoegen, selecteert u de pictogrammen voor hotspot of afbeeldingen met hyperlinks en ziet u [Hotspots en afbeeldingen met hyperlinks toevoegen aan een afbeeldingsbanner](#adding-hotspots-or-image-maps-to-an-image-banner).
...
>[!NOTE]
Als u een klant van de Plaatsen van de Experience Manager bent, kunt u de carrouselbanner rechtstreeks aan uw pagina toevoegen door de Interactieve component van Media aan uw pagina te slepen. Zie [Dynamic Media-elementen toevoegen aan pagina&#39;s](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md).
