...
# Dynamische media configureren {#configuring-dynamic-media-scene-mode}
...
1. Wanneer de verbinding is gelukt, stelt u het volgende in:
...
Als u een geselecteerde map wilt markeren voor synchronisatie met Dynamic Media, opent u de pagina Eigenschappen van de elementenmap. Tik op het tabblad **[!UICONTROL Details]** en kies vervolgens in de vervolgkeuzelijst **[!UICONTROL Dynamische media-synchronisatiemodus]** een van de volgende drie opties en sla vervolgens op **[!UICONTROL Opslaan]**.
   ...
   >[!NOTE]
   >
   >Er is geen ondersteuning voor versioning in Dynamic Media. Ook, is de vertraagde activering slechts van toepassing als de **[!UICONTROL Publish Activa]** in Edit Dynamische pagina van de Configuratie van Media aan **[!UICONTROL Activation]** wordt geplaatst, en dan slechts tot de eerste keer het element wordt geactiveerd.
   >
   >
...
>[!NOTE]
>
>Standaard geeft het systeem 15 uitvoeringen weer wanneer u **[!UICONTROL Uitvoeringen]** en 15 viewervoorinstellingen selecteert wanneer u **[!UICONTROL Viewers]** selecteert in de gedetailleerde weergave van het element. U kunt deze limiet verhogen. Zie Het aantal voorinstellingen voor afbeeldingen [vergroten of verkleinen om het aantal voorinstellingen voor viewers dat wordt weergegeven](/help/assets/dynamic-media/managing-image-presets.md#increasing-or-decreasing-the-number-of-image-presets-that-display) , [te vergroten of te verkleinen](/help/assets/dynamic-media/managing-viewer-presets.md#increasing-the-number-of-viewer-presets-that-display).
