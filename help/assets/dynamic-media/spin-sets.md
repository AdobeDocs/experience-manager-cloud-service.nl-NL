...
>
>Zie &quot;Creating batch set presets to auto-generate Image Sets and Spin Sets&quot; in [Configure Dynamic Media](/help/assets/dynamic-media/config-dm.md).
...
1. Navigeer in Elementen naar de plaats waar u een centrifugeset wilt maken, selecteer **[!UICONTROL Create]** en selecteer **[!UICONTROL Spin Set]**. U kunt de set ook maken vanuit een map die uw assets bevat.
...
1. Voer een van de volgende handelingen uit:
   ...
   * Selecteer **[!UICONTROL Tap to open Asset Selector]** in het midden van de pagina van de Editor voor centrifugeerset.
   Selecteer elementen die u in de centrifugeset wilt opnemen. Geselecteerde assets hebben een vinkje. Als u klaar bent, selecteert u **[!UICONTROL Select]** in de rechterbovenhoek van de pagina.
...
1. Voer een van de volgende handelingen uit:
   ...
   * Selecteer een set met centrifuges en selecteer **[!UICONTROL Edit]** (potloodpictogram) op de werkbalk.
