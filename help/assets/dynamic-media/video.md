...
**** In deze workflow worden de historie en informatie over fouten van het workflowproces vastgelegd. [](#monitoring-video-encoding-and-youtube-publishing-progress) **[!UICONTROL Dynamic Media Encode Video]** **[!UICONTROL DAM Update Asset]**
...
| Grootte | Aspect ratio | Minimum bit rate |
|--- |--- |--- |
...
* **[!UICONTROL Constant Bitrate Encoding]** CBR encoding persists the set data rate to your setting over the entire video. Also, CBR encoding does not optimize media files for quality but does save on storage space.
...
* **[!UICONTROL Variable Bitrate Encoding]** This functionality means that during a VBR encoding process the bitrate of the media file dynamically increases or decreases depending on the media files bitrate needs.
...
| Resolutie | Height (pixels) | Screen size |
|--- |--- |--- |
...
1. **[!UICONTROL Console]**
   ...
   **[!UICONTROL Sign in]****[!UICONTROL Console]**

1. **[!UICONTROL Google Cloud Platform]****[!UICONTROL Select a project]**
1. **[!UICONTROL Select a project]****[!UICONTROL New Project]**
1. **[!UICONTROL New Project]****[!UICONTROL Project name]**
...
1. Do either one of the following:
   ...
   * **[!UICONTROL Getting Started]****[!UICONTROL Explore and enable APIs]**
   * **[!UICONTROL APIs]****[!UICONTROL Go to APIs overview]**

1. **[!UICONTROL APIs & Services]****[!UICONTROL ENABLE APIS AND SERVICES]**<!-- NEXT STEP BELOW IS STEP 10 -->
1. **[!UICONTROL API Library]****[!UICONTROL Category]****[!UICONTROL YouTube]** **[!UICONTROL YouTube]**
1. **[!UICONTROL YouTube]****[!UICONTROL YouTube Data API v3]**
1. **[!UICONTROL YouTube Data API v3]****[!UICONTROL MANAGE]**

   ![](assets/6_5_googleaccount-apis-manage.png)

1. To use the API, you need credentials. **[!UICONTROL Credentials]**

1. **[!UICONTROL CREATE CREDENTIALS]****[!UICONTROL OAuth client ID]**

1. **[!UICONTROL Create OAuth client ID]****[!UICONTROL Application type]****[!UICONTROL Web application]**
...
1. **[!UICONTROL Authorized JavaScript origins]****[!UICONTROL ADD URI]**

   ![](/help/assets/dynamic-media/assets/6_5_googleaccount-apis-nameauthorizations.png)

1. **[!UICONTROL URIs]****[!UICONTROL Enter]**
...
1. **[!UICONTROL Authorized redirect URIs]**
...
1. **[!UICONTROL Create OAuth client ID]****[!UICONTROL Create]**

1. **[!UICONTROL OAuth client created]**

   * (Optional) Copy Your Client ID and Your Client Secret and save.
   * **[!UICONTROL DOWNLOAD JSON]**
...
1. **[!UICONTROL OAuth client created]****[!UICONTROL OK]**
...
1. **[!UICONTROL YouTube settings]**
1. **[!UICONTROL See all my channels or create a channel]**
1. **[!UICONTROL Create a new channel]**
1. **[!UICONTROL Create]**
...
1. **[!UICONTROL Tools]****[!UICONTROL Cloud Services]****[!UICONTROL YouTube Publishing Configuration]**
1. **[!UICONTROL global]**
...
1. **[!UICONTROL Adding one or more channels to YouTube]**
...
1. **[!UICONTROL Setting up tags for publishing]**
...
1. **[!UICONTROL Tools]****[!UICONTROL Deployment]****[!UICONTROL Cloud Services]**
1. **[!UICONTROL Configure now]**
...
1. **[!UICONTROL Available Channels]******
...
Als u het verwerkingsprofiel voor metadata wilt maken, kopieert u eerst waarden uit de velden **[!UICONTROL Field Label]**, **[!UICONTROL Map to property]** en **[!UICONTROL Choices]** die te vinden zijn in de metadataschema&#39;s voor video. Then, you build your YouTube video metadata processing profile by adding those values to it.

****

1. **[!UICONTROL Tools]****[!UICONTROL Assets]****[!UICONTROL Metadata Schemas]**
1. Selecteer **[!UICONTROL default]**. (Do not add a checkmark to the selection box to the left of &quot;default&quot;.)
1. **[!UICONTROL default]****[!UICONTROL video]****[!UICONTROL Edit]**
1. **[!UICONTROL Advanced]**
1. **[!UICONTROL YouTube Category]**
1. **[!UICONTROL Settings]**

   * **[!UICONTROL Map to property]**
...
1. **[!UICONTROL YouTube Privacy]**
1. **[!UICONTROL Settings]**

   * **[!UICONTROL Map to property]**
Paste the copied value into the open text editor. You are going to need this value later when you create your metadata processing profile. Leave the text editor open.

   * **[!UICONTROL Choices]** Notice that the Choices are grouped in pairs of two. The bottom field in the pair is the default value that you want to copy, such as public, unlisted, or private.
Paste the copied value into the open text editor. You are going to need this value later when you create your metadata processing profile. Leave the text editor open.

1. **[!UICONTROL Cancel]**
1. **[!UICONTROL Tools]****[!UICONTROL Assets]****[!UICONTROL Metadata Profiles]**

1. **[!UICONTROL Create]**
1. **[!UICONTROL Profile title]**`YouTube Video`**[!UICONTROL Create]**
1. **[!UICONTROL Advance]**
1. Add the copied YouTube Publishing values to the profile by doing the following:

   * **[!UICONTROL Build Form]**
   * **[!UICONTROL Section Header]**
   * **[!UICONTROL Field Label]**
   * `YouTube Publishing`
   * **[!UICONTROL Build Form]****[!UICONTROL Multi Value Text]****[!UICONTROL YouTube Publishing]**
...
1. Add the copied YouTube Privacy values to the profile by doing the following:
   ...
   * **[!UICONTROL Field Label]**
   * `YouTube Privacy`
   * **[!UICONTROL Build Form]****[!UICONTROL Multi Value Text]****[!UICONTROL YouTube Privacy]**
...
>[!NOTE]
>
>Publish immediately does not automatically publish to YouTube. Wanneer Dynamische media is ingesteld, zijn er twee publicatieopties waaruit u kunt kiezen: **[!UICONTROL Immediately]** of **[!UICONTROL Upon Activation]**.
>
>**[!UICONTROL Publish Immediately]** While that is true for Dynamic Media, it is not true for YouTube. To publish to YouTube, you must publish by way of Experience Manager Author.

>[!NOTE]
**[!UICONTROL Publish to YouTube]**
[](#monitoring-video-encoding-and-youtube-publishing-progress)
...
1. **[!UICONTROL Open Selection Dialog]**
...
1. **[!UICONTROL Select]**
1. **[!UICONTROL Save and Close]**
1. **[!UICONTROL Quick Publish]**
...
**[!UICONTROL Uploaded (processing, please wait)]**
...
>[!NOTE]
**[!UICONTROL Unpublish from YouTube]**
[](#monitoring-video-encoding-and-youtube-publishing-progress)
...
1. **[!UICONTROL Manage Publication]** `. . .`**[!UICONTROL Manage Publication]**
1. **[!UICONTROL Unpublish]**
1. **[!UICONTROL Next]**
1. **[!UICONTROL Unpublish]**
...
1. View video encoding progress in your assets folder:
   ...
   * **[!UICONTROL Processing Status]** Als er een fout is, wordt dit bericht in dezelfde kolom weergegeven.

   ![](assets/chlimage_1-430.png)

   Deze kolom wordt niet standaard weergegeven. **[!UICONTROL View Settings]****[!UICONTROL Processing Status]****[!UICONTROL Update]**

   ![](/help/assets/dynamic-media/assets/chlimage_1-431.png)

1. View progress in the asset details. **[!UICONTROL Timeline]** **[!UICONTROL Workflows]**
   ...
   >[!NOTE]
   **[!UICONTROL retries]****[!UICONTROL retry delay]****[!UICONTROL timeout]**[](https://localhost:4502/system/console/configMgr)
   * Apache Sling Job Queue Configuration
   * Adobe Granite Workflow External Process Job Handler
   * Granite Workflow Timeout Queue

   **[!UICONTROL retries]****[!UICONTROL retry delay]****[!UICONTROL timeout]**
...
1. Use a third-party application or service to create your video caption/subtitle file.
   ...
   **[!UICONTROL Enter URL of video file]****[!UICONTROL Load]** [](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset)**[!UICONTROL Enter URL of video file field]** Internet Explorer, Chrome of Safari kunnen de video vervolgens op een native manier afspelen.
...
1. Voer een van de volgende handelingen uit:
   ...
   * **[!UICONTROL URL]** In the URL dialog box, select and copy the URL to the Clipboard and then past the URL into a simple text editor. Append the copied URL of the video with the following syntax:

      `&caption=<server_path>/is/content/<path_to_caption.vtt_file,1>`

      `,1` `,1``,0`

   * **[!UICONTROL Embed Code]** In the Embed Code dialog box, select, and copy the embed code to the Clipboard and then paste the code into a simple text editor. Append the copied embed code with the following syntax:
   ...
   <table>
     <tbody>
      <tr>
       ...
       <td>
       <ol>
       <li><i></i> Houd er rekening mee dat URL's alleen beschikbaar zijn om te kopiëren <i>nadat</i> u de assets eerst hebt <i>gepubliceerd</i>. <a href="/help/assets/dynamic-media/publishing-dynamicmedia-assets.md"></a></li>
       <li><strong></strong></li>
