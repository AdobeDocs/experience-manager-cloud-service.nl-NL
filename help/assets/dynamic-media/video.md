...
>
>* Zie Dynamische Media Cloud Services [](/help/assets/dynamic-media/config-dm.md#configuring-dynamic-media-cloud-services) configureren in Dynamische media configureren en Dynamische media [](/help/assets/dynamic-media/troubleshoot-dm.md)oplossen.
>
...
Wanneer u het videoverwerkingsprofiel overslaat en rechtstreeks naar YouTube publiceert, betekent dit gewoon dat uw video-element in AEM Asset mogelijk geen zichtbare miniatuur krijgt. Het betekent ook dat video&#39;s die niet zijn gecodeerd, niet werken met de elementtypen Dynamische media.
...
* Zie YouTube vóór 6.4 [instellen in AEM om YouTube vóór 6.4](/help/assets/dynamic-media/video.md#setting-up-youtube-in-aem-before)te configureren in AEM.
...
1. Pas het metagegevensprofiel voor YouTube Publishing toe op de mappen waarin u video&#39;s gaat uploaden. U moet zowel het metagegevensprofiel als het videoprofiel hebben ingesteld.
   ...
   Zie [Metagegevensprofielen](/help/assets/metadata-profiles.md) en [Videoprofielen](/help/assets/dynamic-media/video-profiles.md).
...
>[!NOTE]
>
>Opmerking: in direct publiceren wordt niet automatisch naar YouTube gepubliceerd. Wanneer Dynamische media is ingesteld, zijn er twee publicatieopties waaruit u kunt kiezen: **[!UICONTROL Onmiddellijk]** of **[!UICONTROL bij activering]**.
>
...
1. Zoek in de insluitcode de regel met het volgende:
   ...
   De correcte waarde voor de config2 parameter wordt gevonden in zowel **[!UICONTROL bed Code]** als in de functie van **[UICONTROL URL]** van het exemplaar in. In URL van het bevel van **[UICONTROL URL]** van het exemplaar, is de te zoeken parameter `&config2=<value>` . De waarde is bijna altijd `companypreset`, maar in sommige gevallen ook `companypreset-1`, `companypreset-2`enzovoort.
...
1. U kunt een toepassing of service van derden gebruiken om een ondertitelingsbestand of ondertitelingsbestand voor video te maken.
   ...
   Plak in het veld URL van videobestand **** invoeren van het gereedschap de gekopieerde URL van het videobestand en klik vervolgens op **[!UICONTROL Laden**. Zie Een URL [verkrijgen voor een element](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset) om de URL naar het videobestand zelf op te halen. U kunt deze URL vervolgens in het veld **** URL invoeren van videobestand plakken. Internet Explorer, Chrome of Safari kunnen de video vervolgens op een native manier afspelen.
