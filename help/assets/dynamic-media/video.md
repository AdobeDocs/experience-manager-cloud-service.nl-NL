...
* Door AI gegenereerde bijschriften
...
| Door AI gegenereerde bijschriften | Maak bijschriften voor uw video&#39;s die worden aangedreven door AI. Met AI wordt de transcriptie van de video gemaakt en omgezet in bijschriften. Zelfs de tijdlijn is gedefinieerd. |
...
1. Als u een ondersteuningsgeval wilt maken, volgt u de instructies en zorgt u ervoor dat u de volgende informatie opgeeft:
   ...
   * Geef op of ondersteuning voor DASH-, meervoudige ondertitels en audiotracks en door AI gegenereerde ondertitels moet worden ingeschakeld op uw Dynamic Media-account, op AEM as a Cloud Service.
