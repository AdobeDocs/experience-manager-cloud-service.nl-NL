...
1. Voer in het veld **[!UICONTROL New Viewer Preset]** in het dialoogvenster **[!UICONTROL Preset Name]** de naam van de nieuwe voorinstelling in. Kies een zorgvuldig gekozen naam. U kunt deze niet bewerken nadat u **[!UICONTROL Create]** hebt geselecteerd.
...
Bijvoorbeeld, voor het *type 0&rbrace; VideoPlayer, onder* > **[!UICONTROL Modifiers]**, kunt u uit één van drie adaptieve bitrate het stromen opties selecteren:**[!UICONTROL Playback]**
