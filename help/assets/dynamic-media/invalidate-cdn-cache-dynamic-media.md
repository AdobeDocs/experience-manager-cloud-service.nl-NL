...
| *Er zijn geen URL&#39;s ingevoerd om ongeldig te worden gemaakt.* | Komt voor als er geen URLs aanwezig in **[!UICONTROL CDN Invalidation]** - **[!UICONTROL Confirm]** pagina zijn, en u tikt **[!UICONTROL Submit]**. |
