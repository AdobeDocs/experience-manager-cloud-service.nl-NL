...
>* [Het vormen van selectief publiceren op het omslagniveau in Dynamic Media](/help/assets/dynamic-media/selective-publishing.md#selective-publish-configure-folder)  - zie &quot;de Wijze van de Synchronisatie&quot;in het onderwerp om meer over het synchroniseren van één enkele omslag aan te leren  [!DNL Dynamic Media].
>* [Een nieuwe Dynamic Media-configuratie maken in Cloud Services](/help/assets/dynamic-media/config-dm.md#configuring-dynamic-media-cloud-services)  - Zie &quot;Dynamic Media sync mode&quot; in het onderwerp voor meer informatie over het synchroniseren van alle mappen naar  [!DNL Dynamic Media].