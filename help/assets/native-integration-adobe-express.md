...
7. Klik op **[!UICONTROL Upload]** om de elementen te uploaden naar AEM Assets.
   ...
   >[!NOTE]
   >
   > Als u middelen opslaat in de leveringsopslagplaats van Content Hub, is de naam van het project of de campagne een verplicht veld. U hoeft in dit geval ook geen doelmap te selecteren, omdat deze automatisch wordt afgeleid van metagegevens.
...
|------------------|---------------------------------------------|---------------|
| JPEG | 65 MP (bijvoorbeeld 8 K × 8 K of 16 K × 4 K) | 80 MB desktop, 40 MB mobiel |
| PNG | 65 MP (bijvoorbeeld 8 K × 8 K of 16 K × 4 K) | 80 MB desktop, 40 MB mobiel |
| SVG | — | 250 kB |
| MP4 | 3840 × 3840 pixels | 200 MB |
| PSD | 65 MP (bijvoorbeeld 8 K × 8 K of 16 K × 4 K) | 80 MB desktop, 40 MB mobiel |
| PDF | — | — |
