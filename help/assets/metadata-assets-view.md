...
1. Sleep de vereiste componenten op een tabblad in het formulier vanuit de **[!UICONTROL Components]** -code die beschikbaar is in de linkertrack. Sleep de componenten in de gewenste volgorde.
   ...
   Begrijp het [&#x200B; gebruikersinterface van een Vorm van Meta-gegevens &#x200B;](cascading-metadata-assets-view.md#build-metadata-forms).
...
| Publiceren | Hiermee voegt u de publicatiestatus van het element toe. |
| Koppeling | Er wordt een webadres opgeslagen dat verwijst naar een onlinebron, zoals een webpagina, afbeelding of externe verwijzing. |
| Classificatie | Hiermee wordt een categorische waarde toegevoegd die de kwaliteit van een element aangeeft. |
