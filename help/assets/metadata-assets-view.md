...
>[!IMPORTANT]
>
>Het standaardmetagegevensformulier heeft ook een tab **[!UICONTROL Campaign]** , die **[!UICONTROL Campaign Name]** , **[!UICONTROL Channels]** en **[!UICONTROL Region]** multivalue read-only velden bevat. is een beperkte beschikbaarheidseigenschap. U kunt het toegelaten krijgen door een steunkaartje te creëren.
