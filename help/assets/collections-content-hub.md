...
U kunt ook de elementen delen die beschikbaar zijn in een verzameling. Zorg ervoor om [&#x200B; openbaar verbinding toe te laten delend in Content Hub &#x200B;](configure-content-hub-ui-options.md#configure-collections-content-hub). Navigeer naar de tab **[!UICONTROL Collections]** . Selecteer het ![&#x200B; pictogram van het aandeel &#x200B;](assets/share.svg) pictogram op de activakaart. De koppeling voor delen wordt gekopieerd. U kunt de gekopieerde koppeling delen met de ontvanger. Leer meer over [&#x200B; delend activa in  [!DNL Content Hub]](share-assets-content-hub.md).
...
Content Hub-beheerders kunnen verzamelingen in Content Hub vastzetten, zodat ze snel toegankelijk zijn. Vastgezette verzamelingen worden weergegeven in een speciale sectie Vastgezet op de startpagina van Verzamelingen, zodat belangrijke verzamelingen gemakkelijker binnen bereik blijven. Voor snelle toegang kunt u een verzameling vastzetten of vrijmaken door de onderstaande stappen uit te voeren:
...
1. Blader naar de verzamelingen die u als favorieten wilt markeren.
...
1. Klik **[!UICONTROL More actions]** ![&#x200B; Meer actiepictogram &#x200B;](assets/do-not-localize/more-actions.png) en selecteer **[!UICONTROL Add to Favorites]** om inzameling als Favoriet te merken.
   ...
   Verzamelingen die als Favorieten zijn gemarkeerd, worden nu weergegeven onder het tabblad **[!UICONTROL My Favorites]** . U kunt de verzamelingen ook verwijderen uit **[!UICONTROL My Favorites]** . Om dit te doen, klik **[!UICONTROL More actions]** ![&#x200B; Meer actiepictogram &#x200B;](assets/do-not-localize/more-actions.png) en selecteer **[!UICONTROL Remove from Favorites]**.

   ![&#x200B; verwijder Inzameling als Favoriet &#x200B;](assets/remove-favorite-collection.png)

## Veelgestelde vragen {#faqs-manage-collections-content-hub}

### Wat noemt u verzamelingen in AEM Assets Content Hub?

Een verzameling in AEM Assets Content Hub verwijst naar een set elementen die gebruikers kunnen delen. Verzamelingen kunnen elementen van verschillende locaties bevatten, terwijl hun referentiële integriteit behouden blijft. Ze maken een gedeelde ruimte voor gebruikers om op efficiënte wijze toegang te krijgen tot inhoud en deze te gebruiken.

### Hoe kan ik een nieuwe verzameling maken in AEM Assets Content Hub?

Om een nieuwe inzameling in AEM Assets Content Hub tot stand te brengen, ga naar het lusje van Inzamelingen en klik **creeer Inzameling**. In het nieuwe venster van de Inzameling, voeg een Titel en een Beschrijving toe, selecteer het type van toegangsbeheer onder **die tot** dropdown lijst kan toegang hebben, en **creeert** klikken. Vervolgens kunt u elementen aan de verzameling toevoegen.

### Welke soorten toegangsbeheer beschikbaar zijn wanneer het creëren van een inzameling in AEM Assets Content Hub?

Er zijn drie types van toegangsbeheer in AEM Assets Content Hub: **Privé** - slechts de schepper en de beheerders kunnen uitgeven en toegang hebben, **Openbaar** - Mening slechts - iedereen kan bekijken, maar slechts de schepper en de beheerders kunnen uitgeven, en **Openbaar** - Mening en geeft uit - iedereen kan tot de inzameling zonder beperkingen toegang hebben en uitgeven.

### Wie kan acties uitvoeren op verzamelingen in AEM Assets Content Hub?

AEM Assets Content Hub-gebruikers kunnen verzamelingen maken, weergeven, delen, downloaden, verwijderen, verwijderen, vastzetten en markeren als favorieten. Beheerders hebben aanvullende bevoegdheden, zoals het weergeven van alle toegangsopties en het verwijderen van verzamelingen.

### Hoe voeg ik activa aan een bestaande inzameling in AEM Assets Content Hub toe?

Om activa aan een bestaande inzameling in AEM Assets Content Hub toe te voegen, selecteer de activa u wilt toevoegen, **toevoegen aan inzameling**, en de inzameling kiezen van de lijst. U kunt ook naar verzamelingen zoeken met de zoekbalk. Klik **toevoegen aan inzameling** om de actie te bevestigen.

### Kunnen verzamelingen worden gefilterd en doorzocht in AEM Assets Content Hub?

Ja, verzamelingen kunnen in AEM Assets Content Hub worden gefilterd en doorzocht op naam, toegangsrechten of maker. De filters omvatten opties zoals **Alle Inzamelingen**, **slechts me**, **Iedereen kan** bekijken, **iedereen kan** uitgeven, **die door iedereen** wordt gecreeerd, en **die door me** wordt gecreeerd.

### Hoe kan ik middelen downloaden van een verzameling in AEM Assets Content Hub?

Om activa van een inzameling in AEM Assets Content Hub te downloaden, navigeer aan het **lusje van Inzamelingen** en klik het downloadpictogram op de inzamelingskaart om alle activa te downloaden. U kunt de inzameling ook openen, individuele activa selecteren, en **Download** klikken om hen afzonderlijk te downloaden.

### Hoe kunnen activa van een inzameling in AEM Assets Content Hub worden gedeeld?

Assets kan worden gedeeld door het delen van openbare koppelingen in AEM Assets Content Hub mogelijk te maken. Selecteer het pictogram Delen op de elementenkaart om de koppeling Delen te kopiëren. Deze koppeling kan vervolgens naar ontvangers worden verzonden. Persoonlijke verzamelingen kunnen niet worden gedeeld.

### Wie kan middelen verwijderen uit een collectie in AEM Assets Content Hub?

Een eigenaar van de verzameling, een beheerder of een niet-beheerder met bewerkingsrechten kan een of meer elementen uit een verzameling in AEM Assets Content Hub verwijderen. Om te verwijderen, selecteer de activa en klik **verwijderen uit inzameling**, en bevestig dan de verwijdering.

### Wie mag een verzameling uit AEM Assets Content Hub verwijderen en hoe gebeurt dat?

Alleen beheerders en de maker van een verzameling kunnen deze verwijderen. Als u wilt verwijderen, navigeert u naar het tabblad Verzamelingen, selecteert u de verzameling en klikt u op het pictogram Verwijderen. De verzameling wordt verwijderd uit AEM Assets Content Hub.

### Welke opties kan een beheerder voor inzamelingen in AEM Assets Content Hub vormen?

Beheerders kunnen de volgende opties voor verzamelingen in AEM Assets Content Hub in- of uitschakelen:

* Laat de **knevel van de Inzamelingen van de Mening slechts** toe om inzamelingen toe te staan die aan iedereen maar editable slechts door de schepper en de beheerder toegankelijk zijn.

* Laat de **Openbare Inzamelingen** toe knevel om inzamelingen toe te staan die zowel toegankelijk als editable door iedereen zijn. Als **slechts de Inzamelingen van de Mening** en **Openbare Inzamelingen** knevels gehandicapt zijn, dan door gebrek, kunnen de gebruikers niet-admin slechts privé inzamelingen tot stand brengen.
