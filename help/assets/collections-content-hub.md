...
### Welke types van toegangsbeheer beschikbaar zijn wanneer het creëren van een inzameling?

Er zijn drie types van toegangsbeheer: **Privé** - slechts de schepper en de beheerders kunnen uitgeven en toegang hebben, **Openbaar** - Mening slechts - iedereen kan bekijken, maar slechts creator en beheerders kunnen uitgeven, en **Openbaar** - Mening en geeft uit - iedereen kan tot de inzameling zonder beperkingen toegang hebben en uitgeven.

### Wie kan acties uitvoeren op verzamelingen in Content Hub?

Content Hub-gebruikers kunnen verzamelingen maken, weergeven, delen, downloaden, verwijderen, verwijderen, vastzetten en markeren als favorieten. Beheerders hebben aanvullende bevoegdheden, zoals het weergeven van alle toegangsopties en het verwijderen van verzamelingen.

### Hoe voeg ik activa aan een bestaande inzameling in AEM Assets Content Hub toe?

Selecteer de activa u wilt toevoegen, **toevoegen aan inzameling** klikken, en de inzameling van de lijst kiezen. U kunt ook naar verzamelingen zoeken met de zoekbalk. Klik **toevoegen aan inzameling** om de actie te bevestigen.
...
Assets kan worden gedeeld door het delen van openbare koppelingen in Content Hub mogelijk te maken. Selecteer het pictogram Delen op de elementenkaart om de koppeling Delen te kopiëren. Deze koppeling kan vervolgens naar ontvangers worden verzonden. Persoonlijke verzamelingen kunnen niet worden gedeeld.

### Wie kan middelen verwijderen uit een collectie in AEM Assets Content Hub?

Een eigenaar van de verzameling, een beheerder of een niet-beheerder met bewerkingsrechten kan een of meer elementen uit een verzameling verwijderen. Om te verwijderen, selecteer de activa en klik **verwijderen uit inzameling**, en bevestig dan de verwijdering.
