...
1. Bewerk in het [!UICONTROL Edit metadata page] de volgende velden in het deelvenster **[!UICONTROL Properties]** :
   ...
   * Klik op **[!UICONTROL Save]** om de bovenstaande updates van metagegevens toe te passen op de geselecteerde elementen. Als de gegevens voor **[!UICONTROL Keywords]** , **[!UICONTROL Tags]** en **[!UICONTROL Status]** eenmaal zijn opgeslagen, worden **[!UICONTROL Expiration date]** en **[!UICONTROL Author]** toegevoegd en worden de bestaande gegevens door de bijgewerkte details voor  ,  en  genegeerd.
