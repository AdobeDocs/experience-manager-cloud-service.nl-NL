...
### Hoe kan ik mijn zoekresultaten beperken in AEM Assets Content Hub?

U kunt de zoekresultaten in AEM Assets Content Hub verkleinen door op tekst gebaseerde zoekopdrachten te gebruiken, verschillende filters toe te passen (zoals bestandsindeling, goedkeuringsstatus, wijzigingsdatum, enz.), te zoeken op tags of slimme tags en het deelvenster Filters te gebruiken. Het combineren van veelvoudige predikaten of filteropties helpt u precies de activa richten u nodig hebt.

### Kan ik een bulksgewijs onderzoek in AEM Assets Content Hub naar veelvoudige activa in één keer uitvoeren?

Ja, u kunt een Bulk Onderzoek in AEM Assets Content Hub uitvoeren door veelvoudige waarden (zoals namen, dossierformaten, markeringen) in te gaan die door gespecificeerde afbakening worden gescheiden. Met de functie Bulk zoeken kunt u snel verschillende elementen in één query zoeken, waardoor deze efficiënter werken dan een voor een zoeken naar elementen.


### Kunnen beheerders de filters aanpassen beschikbaar in AEM Assets Content Hub zoeken?

Ja, beheerders kunnen de gebruikersinterface van de Configuratie van AEM Assets Content Hub gebruiken om te vormen welke filters in onderzoeksinterface beschikbaar zijn. Hoewel standaardfilters de bestandsindeling, de goedkeuringsstatus, de vervaldatum en meer bevatten, kunnen beheerders deze opties aanpassen aan de behoeften van de organisatie.
