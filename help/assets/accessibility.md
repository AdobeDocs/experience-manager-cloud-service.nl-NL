...
description: Zorg dat u de toegankelijkheidsfuncties in [!DNL Adobe Experience Manager] als [!DNL Cloud Service] gebruikers met een handicap helpen.
contentOwner: AG
...
* In het dialoogvenster voor het delen van koppelingen kunnen de schermlezers tijdens het navigeren in de bladermodus:
   ...
   * Plaats geen commentaar op de tabelgegevens nadat het dialoogvenster is geladen.
