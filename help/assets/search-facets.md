...
1. Tik op het logo van de Experience Manager en ga naar **[!UICONTROL Tools > General > Search Forms]**.
...
1. Tikken **[!UICONTROL Delete]** ![verwijderpictogram](assets/do-not-localize/deleteoutline.png) in de werkbalk.
