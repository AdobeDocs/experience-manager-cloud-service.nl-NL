...
Onboarding is het proces waarin een aangewezen systeembeheerder opstelling AEM as a Cloud Service voor uw organisatie. Dit omvat de eerste levering van cloudbronnen en het toewijzen van gebruikers aan rollen op basis van hun taakverantwoordelijkheden. Dientengevolge, kan elk lid login en tot hun AEM as a Cloud Service middelen toegang hebben.

![De instapreis](/help/journey-onboarding/assets/onboarding-journey.png)

Deze gids leidt u door de belangrijkste onboarding onderwerpen zodat u na voltooiing zult hebben:
...
* Uw team wordt ingesteld en heeft toegang tot cloudbronnen.
* AEM auteurs hebben toegang tot AEM as a Cloud Service en kunnen beginnen met het maken van inhoud.
* AEM ontwikkelaars en plaatsingsmanagers zullen toegang tot AEM as a Cloud Service hebben en kunnen beginnen creërend en plaatsend douanetoepassingen.
...
* **Het contract** - U moet vertrouwd zijn met uw Adobe-contract omdat het aspecten van het instapproces definieert.
* **Admin Console** - Dit is waar de gebruikers worden geleid en de rollen worden toegewezen.
* **Cloud Manager** - Dit is het hulpmiddel om middelen zoals programma&#39;s en milieu&#39;s op te zetten. Het is ook waar u toegang hebt tot it en pijpleidingen creeert om uw douanecode te beheren en op te stellen.

Deze begrippen zullen in deze instapreis in detail worden uiteengezet. Het doel is dat je aan het einde van de reis:

* de nodige toegang tot AEMaaCS hebben verleend
...
In feite zult u de grond raken die met uw nieuwe AEM as a Cloud Service project loopt!

## Publiek {#audience}

De instapreis wordt specifiek geschreven voor de **systeembeheerder** van de nieuwe klant om as a Cloud Service en AEM in het algemeen te AEM. De systeembeheerder is het individu dat eerst door Adobe wordt gecontacteerd nadat uw AEM as a Cloud Service contract wordt ondertekend, en is typisch de eerste persoon aan toegang en opstelling uw AEM as a Cloud Service middelen. Als u dit leest, bent u waarschijnlijk de systeembeheerder.
...
>[!TIP]
>
>Als u nog niet eerder hebt AEM as a Cloud Service, maar al vertrouwd bent met AEM en migreert van on-premisse of Adobe Managed Services, moet u de optie [AEM as a Cloud Service migratiereis.](/help/journey-migration/getting-started.md)
...
| 8 | [AEM productprofielen toewijzen](assign-profiles-aem.md) | Leer hoe de Beheerder van het Systeem uw teamleden aan AEM as a Cloud Service productprofielen toewijst. | Systeembeheerder |
| 9 | [Taken van ontwikkelaar- en implementatiebeheer](developers.md) | Optioneel - Leer hoe u als ontwikkelaar toegang krijgt tot de Cloud Manager Git en hoe u als implementatiebeheer pijpleidingen kunt instellen en code kunt implementeren in Cloud Manager. | Ontwikkelaars en implementatiemanagers |
| 10 | [AEM](aem-users.md) | Optioneel - Leer hoe u als AEM auteur toegang hebt tot AEM as a Cloud Service exemplaar en hoe u vertrouwd bent met de ontwerpinhoud voor AEM as a Cloud Service. | AEM |

## Volgende functies {#what-is-next}

U bent nu klaar om uw AEM as a Cloud Service instapreis te beginnen. We raden u aan door te gaan met het volgende deel van de reis en het artikel te lezen [Voorbereiding aan boord](preparation.md)
...
Als u wilt weten hoe Adobe u aanbeveelt uw team op uw nieuwe AEM as a Cloud Service toepassing in te schakelen, kunt u hier beginnen!

## Aanvullende bronnen {#additional-resources}

Hieronder volgen aanvullende, optionele bronnen als u verder wilt gaan dan de inhoud van de instapreis.

* [AEM Champion Tips and Tricks - Cloud Manager on boarding Playbook](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/aem-champions/onboarding-playbook.md) - Bekijk deze video om Cloud Manager te leren over instaptips en trucs van een AEM kampioen.
