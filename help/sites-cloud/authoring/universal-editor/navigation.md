...
* [De navigatiebalk Experience Platform boven](#experience-cloud-header)
...
Voor de Universele Redacteur, onder de rubriek **Montages van het Product**, gebruik de **Schakelaar aan de optie van het Milieu van de Voorproef** om tussen de huidige productieversie van de Universele Redacteur en de aanstaande [&#x200B; voorproefversie te schakelen.](/help/release-notes/universal-editor/preview.md)
...
Door gebrek, opent de redacteur zodat u [&#x200B; auteursinhoud &#x200B;](/help/sites-cloud/authoring/universal-editor/authoring.md) of op zijn plaats kunt of het gebruiken van het [&#x200B; eigenschappen paneel.](#properties-rail)
...
* Als u met de rechtermuisknop op een item in de structuur klikt, wordt een contextmenu geopend met de juiste handelingen voor het item.
...
>[!TIP]
>
>Gebruik de sneltoets `Command+d` om een geselecteerde component uit een container te verwijderen.
