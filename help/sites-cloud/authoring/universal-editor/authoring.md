...
>[!TIP]
>
>Zie het document voor een meer gedetailleerde inleiding tot de Universal Editor [Introductie van de Universal Editor.](/help/implementing/universal-editor/introduction.md)
...
>[!TIP]
>
>Zie [Aan de slag met de Universal Editor in AEM](/help/implementing/universal-editor/getting-started.md) voor een voorbeeld van hoe u een AEM toepassing configureert voor gebruik met de Universal Editor.

## De universele editor openen {#accessing}

Zodra de app van instrumenten is voorzien om met de Universele Redacteur te werken, kan de Universele Redacteur tot zowel binnen AEM as a Cloud Service als direct toegang hebben zonder tot AEM toegang te hebben.

### Toegang verkrijgen binnen AEM as a Cloud Service {#accessing-aem}

1. Meld u aan bij uw AEM as a Cloud Service ontwerpinstantie.
1. Gebruik de [**Sites** console](/help/sites-cloud/authoring/sites-console/introduction.md) om naar de pagina te navigeren die is gemaakt voor gebruik met de universele editor die u wilt bewerken.
1. Bewerk de pagina.
1. De Universal Editor wordt geopend om de geselecteerde pagina te bewerken.

>[!NOTE]
>
>Wanneer u een pagina bewerkt in het dialoogvenster [**Sites** console,](/help/sites-cloud/authoring/sites-console/introduction.md) de console zal de redacteur aangewezen aan de pagina openen [sjabloon:](/help/sites-cloud/authoring/sites-console/templates.md) De in dit document beschreven Universal Editor of de [pagina-editor.](/help/sites-cloud/authoring/page-editor/introduction.md)

### Direct toegang {#accessing-directly}

1. Meld u aan bij de Universal Editor. U hebt een Adobe ID nodig om u aan te melden en [toegang hebben tot de Universal Editor.](/help/implementing/universal-editor/getting-started.md#request-access)

1. Nadat u bent aangemeld, voert u de URL van de pagina die u wilt bewerken in het dialoogvenster [locatiebalk.](#location-bar) zodat u inhoud zoals [tekstinhoud](#text-mode) of [media-inhoud.](#media-mode)
...
>[!NOTE]
>
>Elke pagina die u wilt bewerken met de universele editor moet [van instrumenten voorzien om de Universele Redacteur te steunen.](/help/implementing/universal-editor/getting-started.md)
