...
>[!NOTE]
>
>In dit document wordt ervan uitgegaan dat u al vertrouwd bent met de toegang tot en navigatie in de Universal Editor. Als u niet bent, zie [ Toegang tot en Navigerend de Universele Redacteur.](/help/sites-cloud/authoring/universal-editor/navigation.md)
...
Inhoud bewerken is eenvoudig en intuïtief. Terwijl u de muis boven de inhoud in de editor houdt, wordt bewerkbare inhoud gemarkeerd met een dunne, lichtblauwe omtrek en een badge.

![ Bewerkbare inhoud wordt benadrukt door een lichtblauwe doos ](assets/editable-content.png)

Als u op de gemarkeerde inhoud tikt of erop klikt, wordt de dunne, lichtblauwe omtrek een donkerblauwe omtrek met een badge.

![ de Geselecteerde inhoud wordt benadrukt door een donkerblauwe doos ](assets/selected-content.png)
...
Afhankelijk van de inhoud u selecteert, kunt u verschillende op zijn plaats het uitgeven opties en extra informatie en opties voor de inhoud in het [ eigenschappen paneel hebben.](/help/sites-cloud/authoring/universal-editor/navigation.md#properties-rail)

### Contextmenu {#context-menu}

Elk stuk bewerkbare inhoud is gemarkeerd met het type inhoud dat het is.

U kunt op dit symbool klikken om snel een contextmenu te openen met bewerkingen. Als u met de rechtermuisknop op een niet-geselecteerd bewerkbaar item klikt, wordt dit automatisch geselecteerd en wordt ook het contextmenu geopend.

![ Editable badge opties ](assets/editable-badge.png)
...
De dunne, lichtblauwe omtrek verandert in een donkerblauwe omtrek om de selectie aan te geven en er verschijnt een cursor. Breng de wijzigingen aan en druk vervolgens op Enter/Return of selecteer buiten het tekstvak om de wijzigingen op te slaan.
...
#### Contextmenu RTF {#rich-text-context-menu}

Een contextmenu wordt boven het tekstblok met tekstopmaak geopend en biedt in de context basisopmaakopties. Vanwege ruimtebeperkingen kunnen sommige opties achter de knop voor ovaal worden verborgen.
...
![ rijke tekstcomponent in het eigenschappen paneel ](assets/rich-text-properties-panel.png)
...
Met de RTE-editor (RTE) van de Universal Editor kan de auteur de standaardopmaak voor tekst toepassen. De volgende opties zijn beschikbaar.

* **Stijl van de Paragraaf**
   * Alinea, h1-h6, code
* **Vet**
* **Cursief**
* **Onderstrepen**
* **Doorhalen**
* **Kleur van de Tekst**
   * Hiermee opent u een kleurenpalet waarin u een kleur kunt selecteren of een hexadecimale waarde kunt opgeven
   * Alleen beschikbaar in de modale editor, niet in de context
* **Superscript**
* **Subscript**
* **Lijst van de Opsommingstekens**
   * Gebruik de tabtoets om te inspringen en shift+tab om uit te springen.
* **Geordende lijst**
   * Gebruik de tabtoets om te inspringen en shift+tab om uit te springen.
* **Verbinding**
   * Geef een URL op of gebruik de Inhoudsbrowser om een pad in AEM te selecteren.
* **ontkoppelen**
   * Koppeling verwijderen uit geselecteerde tekst.
* **Beeld**
   * Specificeer URL of gebruik de [ activa selecteur ](/help/assets/overview-asset-selector.md#using-asset-selector) om activa van AEM te selecteren.
* **Lijst**
   * Gebruik de vervolgkeuzelijst om een nieuwe tabel in te voegen met het geselecteerde aantal kolommen en rijen of nieuwe kolommen/rijen in te voegen en te verwijderen.
* **Uitlijning**
   * **richt links**
   * **richt Centrum**
   * **richt rechts**
...
* **Uitspringen**
* **Deeg als Tekst**
   * Verwijder opmaak van tekst op het klembord voordat u deze in de Universal Editor plakt.
* **verwijdert Al het formatteren**
   * Verwijder alle opmaakopties uit de geselecteerde tekst.

Afhankelijk van de achterkant kunnen de standaardopties variëren. De RTE kan worden gevormd om opties te verbergen of extra opties te tonen afhankelijk van auteurs&#39; behoeften. Gelieve te zien het document [ Vormend RTE voor de Universele Redacteur ](/help/implementing/universal-editor/configure-rte.md) voor meer informatie.
...
Als u a [ het Fragment van de Inhoud ](/help/sites-cloud/administering/content-fragments/overview.md) selecteert, kunt u zijn details in het [ eigenschappen paneel uitgeven.](/help/sites-cloud/authoring/universal-editor/navigation.md#properties-rail)
...
1. U kunt dan:
   ...
   * Selecteer **voeg** pictogram in het eigenschappenpaneel toe.

     ![ Uitgezocht voeg pictogram toe ](assets/add-icon.png)

   * Selecteer **toevoegen** optie in het contextmenu.

     ![ voeg van contextmenu ](assets/add-from-context-menu.png) toe

1. Het dialoogvenster Componentkiezer wordt geopend.
   * Gebruik de linkerkolom om componenten op categorie te filteren of gebruik de zoekopdracht om op naam te filteren.
   * Klik op de naam van de component in de rechterkolom om deze in de container in te voegen.
   * Als slechts één component in de container wordt toegestaan, wordt het opgenomen automatisch.
   * Klik buiten de kiezer om de invoeging van de component te annuleren.

   ![ de plukker van de Component ](assets/component-picker.png)
...
1. U kunt dan:
   ...
   * Selecteer het **Dubbele** pictogram in het eigenschappen paneel.

     ![ Selecterend een component om aan een container ](assets/ue-duplicate-component.png) toe te voegen

   * Selecteer de **Dubbele** optie van het contextmenu.

     ![ Dupliceren van contextmenu ](assets/duplicate-from-context-menu.png)

De component wordt gedupliceerd en onder de geselecteerde component ingevoegd.

### Componenten uit containers verwijderen {#deleting-components}

1. Selecteer een component in een container in de [ inhoudsboom ](/help/sites-cloud/authoring/universal-editor/navigation.md#content-tree-mode) of in de redacteur.
1. U kunt dan:
   * Selecteer het **pictogram van de Schrapping** in het eigenschappen paneel.

     ![ Deleting a component ](assets/ue-delete-component.png)
   * Selecteer de **schrapping** optie in het contextmenu.
     ![ Schrapping van het contextmenu ](assets/delete-from-context-menu.png)
...
### Componenten opnieuw ordenen en verplaatsen {#reordering-components}

U kunt componenten verplaatsen en opnieuw ordenen met het contextmenu of de inhoudsstructuur.

#### Componenten verplaatsen met het contextmenu {#move-context-menu}

1. Klik op een component met de rechtermuisknop aan of klik op het geselecteerde symbool van de component om het [ contextmenu te openen.](#context-menu)
1. Selecteer de gewenste verplaatsingsoptie.
   * Naar boven
   * Omhoog verplaatsen
   * Omlaag verplaatsen
   * Verplaatsen naar beneden
     ![ de opties van de beweging in contextmenu ](assets/move-options-in-conext-menu.png)

De component wordt zowel in de editor als in de inhoudstructuur verplaatst.

>[!TIP]
>
>Gebruik de sneltoetsen `Command-U` of `Shift-Command-U` om respectievelijk naar boven of naar boven te gaan.
>Gebruik de sneltoetsen `Command-J` of `Shift-Command-J` om respectievelijk naar beneden of naar beneden te gaan.

>[!NOTE]
>
>Met de opties in contextmenu&#39;s kunt u alleen componenten binnen de bijbehorende containers verplaatsen. Als u wenst om componenten tussen containers te bewegen, [ gebruik de inhoudsboom.](#reorder-content-tree)

#### Componenten opnieuw ordenen met de inhoudsstructuur {#reorder-content-tree}
...
1. U kunt dan:
   * Klik het **pictogram van het Exemplaar** in het [ eigenschappen paneel.](/help/sites-cloud/authoring/universal-editor/navigation.md#properties-panel)
     ![ Exemplaar van paneel ](assets/copy-from-panel.png)
   * Selecteer de **optie van het Exemplaar** in het contextmenu.
     ![ Exemplaar van contextmenu ](assets/copy-from-context-menu.png)
1. Selecteer de component _na_ die u wenst om de gekopieerde component te kleven.
1. U kunt dan:
   * Tik of klik **Deeg** in het eigenschappen paneel.
     ![ Deeg van paneel ](assets/paste-from-panel.png)
   * Selecteer **Deeg** in het contextmenu.
     ![ Deeg van contextmenu ](assets/paste-from-context-menu.png)

De gekopieerde component wordt gekleefd _na_ de geselecteerde component.
