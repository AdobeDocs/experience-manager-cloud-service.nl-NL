...
U kunt componenten kopiëren en kleven die binnen [ containers ](/help/implementing/universal-editor/field-types.md#container) op zelfde browser tabel zijn. Dit is mogelijk slechts als de doelcontainer geen [ gevormde filters ](/help/implementing/universal-editor/filtering.md) heeft of filters heeft die de component toestaan om worden gekleefd.
