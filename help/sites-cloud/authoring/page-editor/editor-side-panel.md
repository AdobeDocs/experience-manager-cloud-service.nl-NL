...
description: Leer hoe u het zijpaneel in de AEM-siteeditor kunt gebruiken om componenten en elementen aan uw pagina toe te voegen.
...
Leer hoe u het zijpaneel in de AEM-siteeditor kunt gebruiken om componenten en elementen aan uw pagina toe te voegen.
...
[&#x200B; Componenten &#x200B;](/help/implementing/developing/components/overview.md) zijn de bouwstenen die worden gebruikt om inhoud met de de paginaredacteur van AEM tot stand te brengen. U plaatst veelvoudige componenten op een pagina en vormt hun opties om uw inhoudspagina te bouwen.
