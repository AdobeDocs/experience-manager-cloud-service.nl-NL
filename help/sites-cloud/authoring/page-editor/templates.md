...
* [&#x200B; publiceer het malplaatje &#x200B;](#publishing-a-template-template-author) om het op publiceer milieu beschikbaar te maken
...
Publiceer malplaatjes gebruikend de **[Console van Malplaatjes](/help/sites-cloud/administering/templates-console.md)**.
...
>[!CAUTION]
>
>In AEM worden de gewassenverhoudingen bepaald als **hoogte/breedte**. Dit verschilt van de conventionele definitie van breedte/hoogte en wordt gedaan om oude compatibiliteitsredenen. De pagina auteursende gebruikers zullen zich niet van enig verschil bewust zijn die u de **Naam** duidelijk bepaalt aangezien dit is wat in UI wordt getoond.
...
* Ontgrendelde componenten die beschikbaar zijn voor bewerking, worden gemarkeerd. Als deze optie is geselecteerd, hebben ze een blauwe rand:
  ...
  ![&#x200B; de Eerste wijze van de Inhoud 0&rbrace;](/help/sites-cloud/authoring/assets/templates-initial-content-mode.png)
...
1. [&#x200B; publiceer uw malplaatjes &#x200B;](#publishing-a-template-template-author) van de **[console van Malplaatjes]** (/help/sites-cloud/administering/templates-console.md).
