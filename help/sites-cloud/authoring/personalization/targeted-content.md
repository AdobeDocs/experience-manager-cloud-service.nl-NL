...
1. Gebruik het **Merk** drop-down menu om het merk te selecteren waarvoor u de activiteit wilt tot stand brengen.
   ...
   >[!NOTE]
   >
   >Het wordt geadviseerd om merken door de activiteitenconsole [&#x200B; tot stand te brengen &#x200B;](/help/sites-cloud/authoring/personalization/activities.md#creating-a-brand-using-the-activities-console).
   >
   >
...
1. In het **richten** motor drop-down menu, selecteer uw het richten motor.
   ...
   * Als u **ContextHub AEM** selecteert, worden de resterende gebieden gedimd en niet beschikbaar. Selecteer **creeer**.
