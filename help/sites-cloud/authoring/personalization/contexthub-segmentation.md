...
Deze segmenten worden vervolgens gebruikt om een bezoeker specifieke inhoud te bieden. {de activiteiten van 0} die [&#x200B; hier worden bepaald kunnen op om het even welke pagina worden omvat en bepalen welk bezoekerssegment de gespecialiseerde inhoud van toepassing is.](activities.md)
...
De [&#x200B; console van 0&rbrace; Soorten publiek &lbrace;wordt gebruikt om segmenten voor ContextHub en publiek voor uw rekening van Adobe Target te beheren. &#x200B;](audiences.md) Deze documentatie behandelt het beheren van segmenten voor ContextHub.
