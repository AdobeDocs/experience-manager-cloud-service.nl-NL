...
![ De toolbar ContextHub ](/help/sites-cloud/authoring/assets/contexthub-toolbar.png)

1. Selecteer Voorvertoning op de werkbalk terwijl de pagina is geopend voor bewerken.

   ![ de knoop van de Voorproef ](/help/sites-cloud/authoring/assets/contexthub-preview-button.png)

1. Om de toolbar te openbaren, selecteer het pictogram ContextHub.

   ![ De knoop ContextHub ](/help/sites-cloud/authoring/assets/contexthub-button.png)
...
![ personas ContextHub ](/help/sites-cloud/authoring/assets/contexthub-persona-button.png)
...
![ ContextHub profielinformatie ](/help/sites-cloud/authoring/assets/contexthub-profile.png)
