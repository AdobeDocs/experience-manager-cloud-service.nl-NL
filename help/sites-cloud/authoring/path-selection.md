...
De wegbrowser wordt georganiseerd als de [ kolommening ](/help/sites-cloud/authoring/basic-handling.md#column-view) van de [**3} console van Plaatsen**, die voor meer gedetailleerde selectie van middelen toestaat.](/help/sites-cloud/authoring/sites-console/introduction.md)
