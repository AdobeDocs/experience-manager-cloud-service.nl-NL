...
Als u een taak wilt voltooien, selecteert u de taak en klikt u op **Voltooien**. Voeg informatie aan de taak toe en klik dan **Gedaan**. Zie [Uw Postvak IN](/help/sites-cloud/authoring/getting-started/inbox.md) voor meer informatie.
