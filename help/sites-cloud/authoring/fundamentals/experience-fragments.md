...
1. [Een map maken](/help/sites-cloud/authoring/fundamentals/organizing-pages.md#creating-a-new-folder).
...
1. Sleep de vereiste component vanuit de [Browser voor componenten](/help/sites-cloud/authoring/fundamentals/environment-tools.md#components-browser).
...
Zie voor export naar Adobe Target:
