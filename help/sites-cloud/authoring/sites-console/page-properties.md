...
* **Titel en tags**
   ...
   * **Tags** - Hier kunt u codes aan de pagina toevoegen of eruit verwijderen door de lijst in het selectievak bij te werken.
      ...
      * Zie voor meer informatie over tags [Tags gebruiken](/help/sites-cloud/authoring/sites-console/tags.md).
...
* **Aan/Uit-tijd**
   ...
   * **Op tijd** - De datum en het tijdstip waarop de gepubliceerde pagina zichtbaar wordt gemaakt (weergegeven) in de publicatieomgeving. De pagina moet, of manueel of door pre-gevormde auto-replicatie worden gepubliceerd.
      ...
      * Indien al [gepubliceerd (handmatig)](/help/sites-cloud/authoring/sites-console/publishing-pages.md) deze pagina wordt slapend (verborgen) gehouden totdat deze op het opgegeven tijdstip wordt weergegeven.
...
* **Instellingen**
   ...
   * **Alias** - Hiermee wordt een alias opgegeven die met deze pagina moet worden gebruikt
      ...
      * Pagina&#39;s die door aliassen in de editor worden benaderd, kunnen niet worden gepubliceerd. [Publicatieopties](/help/sites-cloud/authoring/sites-console/publishing-pages.md) in de editor zijn alleen beschikbaar voor pagina&#39;s die via hun werkelijke paden worden benaderd.
...
* **Sjablooninstellingen**
   ...
   * **Toegestane sjablonen** - [Hiermee definieert u de lijst met beschikbare sjablonen](/help/sites-cloud/authoring/sites-console/templates.md#enabling-and-allowing-a-template-template-author) binnen dit subbijkantoor
...
>[!NOTE]
>
>Zie [Progressieve webtoepassingsfuncties inschakelen](/help/sites-cloud/authoring/sites-console/enable-pwa.md).
...
* Van de **Sites** console:
   * [Een nieuwe pagina maken](/help/sites-cloud/authoring/sites-console/creating-pages.md#creating-a-new-page) (een subset van de eigenschappen)
