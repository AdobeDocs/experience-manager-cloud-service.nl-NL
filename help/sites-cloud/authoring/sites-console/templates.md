...
* [De sjabloon bewerken](#editing-templates-template-authors) om de volgende waarden te definiëren:
   ...
   * [Stijlen](/help/sites-cloud/authoring/page-editor/style-system.md) - Definieer de stijlen die met de sjabloon en de componenten ervan moeten worden gebruikt.
...
1. U kunt nu uw sjabloon gebruiken wanneer [een pagina maken](/help/sites-cloud/authoring/sites-console/creating-pages.md#creating-a-new-page), hoewel u waarschijnlijk [de sjabloon bewerken](#editing-templates-template-authors) volgens uw vereisten.
...
1. Open de [Pagina-eigenschappen](/help/sites-cloud/authoring/sites-console/page-properties.md) voor de hoofdpagina van de vertakking waar u het malplaatje beschikbaar wilt zijn.
...
Zie de [documentatie over stijlsystemen](/help/sites-cloud/authoring/page-editor/style-system.md) voor meer informatie .
...
>[!NOTE]
>
>Hoewel niet identiek, heeft het toevoegen van componenten en activa aan een malplaatje vele gelijkenissen met gelijkaardige acties wanneer [pagina&#39;s ontwerpen.](/help/sites-cloud/authoring/page-editor/edit-content.md)
...
U kunt de sjabloonlay-out voor een reeks apparaten definiëren. [Responsieve indeling](/help/sites-cloud/authoring/page-editor/responsive-layout.md) voor sjablonen werkt op dezelfde manier als voor het ontwerpen van pagina&#39;s.
...
Met de **Oorspronkelijke pagina-eigenschappen** kunt u het eerste [pagina-eigenschappen](/help/sites-cloud/authoring/sites-console/page-properties.md) te gebruiken bij het maken van resulterende pagina&#39;s.
