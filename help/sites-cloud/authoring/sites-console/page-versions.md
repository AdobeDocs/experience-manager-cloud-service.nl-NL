...
1. Selecteer de pagina in [selectiemodus](/help/sites-cloud/authoring/basic-handling.md#viewing-and-selecting-resources).
...
* de **Deze versie herstellen** van de [Tijdlijn](/help/sites-cloud/authoring/basic-handling.md#timeline) spoor

  Vorige versie van geselecteerde pagina opnieuw installeren.

* de **Herstellen** opties van boven [werkbalk Handelingen](/help/sites-cloud/authoring/basic-handling.md#actions-toolbar)
...
1. Navigeren naar en [selecteren](/help/sites-cloud/authoring/basic-handling.md#viewing-and-selecting-resources), de vereiste map.

1. Selecteren **Herstellen** vervolgens **Versie herstellen** vanaf boven [werkbalk Handelingen](/help/sites-cloud/authoring/basic-handling.md#actions-toolbar).
...
1. Selecteren **Herstellen** vervolgens **Boom herstellen** vanaf boven [werkbalk Handelingen](/help/sites-cloud/authoring/basic-handling.md#actions-toolbar). De meest recente versie van de boomstructuur wordt weergegeven:
...
1. Selecteren **Voorvertoning**. De pagina wordt weergegeven op een nieuw tabblad.
   ...
   >
   >Als u problemen ondervindt met een voorvertoning, controleert u de [Tijdlijn](/help/sites-cloud/authoring/basic-handling.md#timeline) om te zien of de pagina is verplaatst.
...
1. Selecteren **Vergelijken met huidige**. De [pagina diff](/help/sites-cloud/authoring/sites-console/page-diff.md) opent en toont de verschillen.
...
Timewaring is een [mode](/help/sites-cloud/authoring/page-editor/introduction.md#page-modes) van de pagina-editor. Om het te beginnen, eenvoudig schakelaar het zoals u een andere wijze.
