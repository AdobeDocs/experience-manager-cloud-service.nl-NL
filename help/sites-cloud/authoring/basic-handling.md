...
| Personalisatie | Deze console verstrekt een kader van hulpmiddelen voor [ creërend gerichte inhoud en presenterend gepersonaliseerde ervaringen ](/help/sites-cloud/authoring/personalization/overview.md). |
...
![ het paneel van Hulpmiddelen ](assets/basic-handling-tools.png)
...
* **Toolbar** - afhankelijk van uw plaats, opent het **pictogram van de Hulp** de aangewezen middelen:
...
* **Redacteur van de Pagina** - de eerste keer u uitgeeft een pagina een reeks dia&#39;s introduceert de paginaredacteur.
