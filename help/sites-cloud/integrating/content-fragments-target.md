...
1. Onder **Adobe Target** selecteren:
   ...
   * indien vereist - het externalizer-domein
   ...
   ![Map - Cloud Services](assets/cf-target-integration-01.png "Map - Cloud Services")
...
>
>Daarom moet het inhoudsfragment, met alle gerelateerde elementen, worden gepubliceerd voordat u het naar Target exporteert.
...
1. Tikken/klikken **OK** in het bevestigingsdialoogvenster.
   ...
   >[!NOTE]
   >
   >[Diverse details](/help/sites-cloud/authoring/fundamentals/content-fragments.md#details-of-your-content-fragment) van de uitvoer **Lijstweergave** van de console en **Eigenschappen**.
...
## Een inhoudsfragment verwijderen dat al naar Adobe Target is geëxporteerd {#deleting-a-content-fragment-already-exported-to-adobe-target}
