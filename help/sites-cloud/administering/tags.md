---
title: Tags beheren
description: Leer hoe u tags in AEM kunt beheren om uw inhoud te ordenen.
...
1. [&#x200B; publiceer de markering &#x200B;](#publishing-tags).
...
1. Verstrek de noodzakelijke informatie.
   ...
   * **Naam** - als een naam niet wordt gespecificeerd, wordt een geldige knoopnaam gecreeerd van de **Titel**. Zie het document [&#x200B; AEM Tagging Kader &#x200B;](/help/implementing/developing/introduction/tagging-framework.md#tagid) voor meer informatie.
...
Net als bij het maken van andere inhoud in AEM, nadat u een tag (of naamruimte) hebt gemaakt, bestaat deze alleen in de ontwerpomgeving. De tags zijn alleen beschikbaar voor gebruikers als u deze publiceert.

1. Om een markering te publiceren, open de [&#x200B; etiketterende console &#x200B;](#tagging-console).

1. Selecteer de markering of de markeringen u en in de toolbar wilt publiceren, uitgezocht **publiceren**.

   ![&#x200B; Selecterend markeringen in de console &#x200B;](assets/select-tags.png)

1. Het **publiceert de dialoog van de Markering** vraagt om een bevestiging om de geselecteerde markeringen te publiceren. Selecteer **publiceren**.

   ![&#x200B; de Publish bevestiging van de Markering modaal &#x200B;](assets/publish-tag.png)

1. De publicatieactie wordt bevestigd met de dialoog van het Succes van a **&#x200B;**.

   ![&#x200B; publiceer de dialoog van het markeringssucces &#x200B;](assets/publish-tag-success.png)
...
1. De **Unublish dialoog van de Markering** vraagt om een bevestiging om de geselecteerde markeringen te publiceren. Selecteer **publiceren**.

   ![&#x200B; de Publish bevestiging van de Markering modaal &#x200B;](assets/unpublish-tag.png)

1. De unpublish actie wordt bevestigd met de dialoog van het Succes van a **&#x200B;**.

   ![&#x200B; publiceer de dialoog van het markeringssucces &#x200B;](assets/unpublish-tag-success.png)
...
1. AEM controleert of er niet naar de tag wordt verwezen.
   ...
   1. Als er geen referenties worden gevonden, vraagt AEM om definitieve bevestiging om te verwijderen. Selecteer **Schrapping**

      ![&#x200B; Geen gevonden verwijzingen &#x200B;](assets/no-references-found.png)

   1. Als er verwijzingen worden gevonden, worden deze door AEM gepresenteerd en wordt de laatste bevestiging gevraagd om te worden verwijderd.
...
Om een nieuwe taal aan de dialoog toe te voegen, zie het document [&#x200B; Bouw Tagging in de Toepassingen van AEM &#x200B;](/help/implementing/developing/introduction/tagging-applications.md#adding-a-new-language-to-the-edit-tag-dialog)

>[!TIP]
>
>Als u meer over de lokalisatiefuncties van AEM wilt leren, zie [&#x200B; Vertaal Uw Inhoud voor Meertalige Plaatsen &#x200B;](/help/sites-cloud/administering/translation/overview.md).
