...
De volgende tabel bevat een lijst met synchronisatiehandelingen die buiten de box met AEM worden uitgevoerd.
...
| Naam van handeling | Beschrijving | Properties |
|---|---|---|
...
U kunt verscheidene diensten vormen OSGi die overeenkomstige synchronisatieacties steunen zodat zij geen specifieke knooptypes en eigenschappen beïnvloeden. Veel eigenschappen en subknooppunten die bijvoorbeeld te maken hebben met de interne werking van AEM, mogen niet worden opgenomen in een live kopie. Alleen de inhoud die relevant is voor de gebruiker van de pagina moet worden gekopieerd.

Wanneer u met AEM werkt, zijn er verschillende methoden om de configuratie-instellingen voor dergelijke services te beheren. Zie [&#x200B; Vormend OSGi &#x200B;](/help/implementing/deploying/configuring-osgi.md) voor meer details en geadviseerde praktijken.
