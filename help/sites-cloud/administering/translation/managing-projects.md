...
description: Leer hoe u zowel machine- als menselijke vertaalprojecten kunt maken en beheren in AEM.
...
De vertaalprojecten in AEM gebruiken de standaard [ de projectenconsole van AEM ](/help/sites-cloud/authoring/projects/overview.md). Als u niet vertrouwd bent met de projecten van AEM, herzie die documentatie.
...
Hoewel AEM verschillende vertaaloplossingen en -interfaces biedt, is het ook mogelijk om handmatig vertaaltaakgegevens te importeren en te exporteren.
