---
title: Een overzicht van Concepten en Beste praktijken van het Werken met de Fragmenten van de Inhoud
...
* **Variaties**
   ...
   * Uitvoeringen van fragmenttekst die specifiek zijn voor redactionele doeleinden; kan worden gekoppeld aan een kanaal, maar dit is niet verplicht; kan ook worden gebruikt voor lokale ad-hocwijzigingen.
...
* a **Model van het Fragment van de Inhoud**
   ...
   * Is [ toegelaten gebruikend Browser van de Configuratie ](/help/sites-cloud/administering/content-fragments/setup.md).
...
* Velden
  ...
  Beperk het aantal RTF-velden per model. Vanwege de prestaties is het niet raadzaam meer dan tien RTF-velden in één model op te nemen. Indien nodig, wordt het geadviseerd dat u [ genestelde Fragments van de Inhoud ](/help/sites-cloud/administering/content-fragments/content-fragment-models.md#using-references-to-form-nested-content) gebruikt.
