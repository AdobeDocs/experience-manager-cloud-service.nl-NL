...
De Universele Redacteur biedt a **What You See Is What You Get (WYSIWYG)** ervaring aan die precies toont hoe uw vormen aan gebruikers zullen verschijnen. Of u nu nieuw bent in het formuliergebouw of een ervaren ontwikkelaar, deze handleiding helpt u:
...
**wanneer te gebruiken:** Na grondig het testen in Voorproef en Responsieve wijzen
    ...
    ![Publiceren](/help/edge/docs/forms/universal-editor/assets/ue-publish.png)
...
#### **Wijze van Eigenschappen** (`d` kortere weg)
...
+++door AI aangedreven Hulpmiddelen
