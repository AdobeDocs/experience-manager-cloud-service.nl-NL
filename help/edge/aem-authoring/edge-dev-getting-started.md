...
1. Download de recentste AEM Authoring met Edge Delivery Services sitesjabloon van GitHub op [`https://github.com/adobe-rnd/aem-boilerplate-xwalk/releases`](https://github.com/adobe-rnd/aem-boilerplate-xwalk/releases).
...
1. Upload AEM Authoring met Edge Delivery Services sitesjabloon dat u van GitHub hebt gedownload.
